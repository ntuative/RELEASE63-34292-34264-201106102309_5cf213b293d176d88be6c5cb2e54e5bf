package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1642:uint = 16777215;
      
      private static const const_1641:uint = 12247545;
      
      private static const const_1644:String = "HELP";
      
      private static const const_1643:String = "ROOMINFO";
      ...
      private var var_714:IWindowContainer;
      
      private const const_805:int = 41;
      ...
      {
         this.var_64.removeListItem(this.var_368);
      }
      
      public function showRoomInfo() : void
      {
         this.var_64.addListItemAt(this.var_368,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_959;
         _loc3_.y = this.const_805;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_714)
         {
            this.var_714 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1644);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1643);
               break;
            case "confirm":
               if(false)
               {
