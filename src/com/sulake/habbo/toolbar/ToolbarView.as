package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1450:Point = new Point(3,3);
      
      private static const const_1449:uint = 7433577;
      
      private static const const_1448:uint = 5723213;
      
      private static const const_463:String = "_hover";
      
      private static const const_462:String = "_normal";
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1450;
         ...
         {
            this.setIconHoverState(_loc11_,const_462);
         }
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_871:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_819:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_462);
               this.setIconBgHoverState(_loc3_,const_462);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_463 ? this.var_1474 : this.var_1473;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_463)
         {
            param1.color = const_1449;
         }
         else
         {
            param1.color = const_1448;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1473 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1474)
         {
            this.var_1474.dispose();
         }
         this.var_1474 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_981.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
