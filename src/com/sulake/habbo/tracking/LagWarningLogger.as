package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         this.var_2045 = Boolean(int(param1.getKey("lagWarningLog.enabled","1")));
         this.var_1958 = int(param1.getKey("lagWarningLog.interval.seconds","10")) * 1000;
      }
      
      public function chatLagDetected(param1:int) : void
      {
         if(!this.var_2045 || this.var_1958 <= 0)
         {
            return;
         }
         ++this.var_1269;
      ...
      private function reportWarningsAsNeeded(param1:int) : void
      {
         ...
         if(this._lastWarning == 0 || param1 - this._lastWarning > this.var_1958)
         {
