package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1678:uint = 1;
      ...
      private var var_1112:IWindowRenderer;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_302:Array;
      
      private var var_1660:IEventDispatcher;
      
      private var var_1366:Boolean = false;
      
      private var var_2145:ProfilerOutput;
      
      private var var_1661:ProfilerAgentTask;
      
      private var var_1662:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1112 = new WindowRenderer(this._skinContainer);
         this._windowContextArray = new Array(const_475);
         ...
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_1112,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_725 = this._windowContextArray[const_1678];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2145)
            {
               this.var_2145 = new ProfilerOutput(context,this,this.var_1112);
            }
            this.var_2145.profiler = _loc3_;
            this.var_1661 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1661);
            this.var_1662 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1662);
            this.var_1366 = true;
         }
      }
      ...
      {
         return this.var_725.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_725.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_725.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_420.length > 0)
         {
            this.var_1660.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_475 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1660.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_420.length > 0)
         {
            WindowContext.var_420.flush();
         }
         MouseCursorControl.change();
         this.var_1660.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1888,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1914,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1859,param2.name + ": " + param2.toString());
            }
         }
      }
