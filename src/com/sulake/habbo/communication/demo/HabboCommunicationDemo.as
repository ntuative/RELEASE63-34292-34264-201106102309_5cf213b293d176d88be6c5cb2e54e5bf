package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2653:PseudoRandom;
      ...
      private const const_2014:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_672 = param1;
            this.var_59.initConnection(HabboConnectionType.const_265);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_59 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_59.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_59.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_59.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_59.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_59.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_59.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_59.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_59.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_59.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_59.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_59.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_59.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_59.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_59.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_59 && this.var_150 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_150.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_243 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_150.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_150.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_243.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_150.getKey("use.sso.ticket") == "1";
         this.var_672 = this.var_150.getKey("sso.ticket",null);
         this.var_1933 = this.var_150.getKey("flash.client.url","");
         this.var_2655 = this.var_150.getKey("external.variables.txt","");
         if(this.var_243 == null)
         {
            this.var_243 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_59.mode = HabboConnectionType.const_96;
            if(this.var_672)
            {
               this.var_59.initConnection(HabboConnectionType.const_265);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_644,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1797);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_59.mode = HabboConnectionType.const_96;
            if(this.var_150.keyExists("local.environment"))
            {
               this.var_59.mode = HabboConnectionType.const_1373;
            }
         }
         this.var_59.initConnection(HabboConnectionType.const_265);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_59.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_998);
            _loc3_ = new InitCryptoMessageComposer(this.var_59.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2653 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_59.mode)
         {
            case HabboConnectionType.const_96:
               _loc6_ = "";
               _loc6_ = this.var_150.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_150.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1545 = _loc4_;
               this.var_243.loadBannerImage(_loc7_ + "?token=" + this.var_1545,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1373:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1724:
               this.var_1037 = this.generateRandomHexString(30);
               this.var_558 = new DiffieHellman(new BigInteger(this.var_150.getKey("connection.development.prime"),16),new BigInteger(this.var_150.getKey("connection.development.generator"),16));
               this.var_558.init(this.var_1037);
               _loc8_ = this.var_558.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_59.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2653);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1933,this.var_2655));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2014,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_672 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_672);
            _loc2_.send(_loc4_);
      ...
      {
         var _loc4_:IConnection = this.var_59.getHabboMainConnection(null);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2654)
         {
            _loc2_ = this.var_150.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2654 = true;
         var _loc2_:String = this.var_150.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_150.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1545);
         ...
         var _loc9_:IConnection = this.var_59.getHabboMainConnection(null);
