package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class Tab implements ITab
   {
      ...
      public static var var_1118:IHabboFriendBarData;
      
      public static var var_1385:IHabboFriendBarView;
      
      public static var ASSETS:IAssetLibrary;
      
      public static var WINDOWING:IHabboWindowManager;
      
      public static var var_2165:IHabboLocalizationManager;
      
      public static var var_2199:TextCropper;
      ...
      protected function onMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         if(this.selected)
         {
            var_1385.deSelect(true);
         }
         else
         {
            var_1385.selectTab(this,true);
         }
      }
