package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || _hover,!!_hover ? int(const_1059) : int(const_1060));
         if(!var_908 && !_hover)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_908,!!_hover ? int(const_1059) : int(const_1060));
         if(!var_908 && !_hover)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
