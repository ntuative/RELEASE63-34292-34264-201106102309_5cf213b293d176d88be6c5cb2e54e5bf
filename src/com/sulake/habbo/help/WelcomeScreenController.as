package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function dispose() : void
      {
         if(this.var_188)
         {
            this.var_188.removeUpdateReceiver(this);
            this.var_188.toolbar.events.removeEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
            this.var_188 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_69 = param1;
         this.var_188.toolbar.events.addEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
         if(this._window == null)
         {
            this.initializeWindow();
         }
         var _loc2_:ITextWindow = ITextWindow(this._window.findChildByName("text"));
         _loc2_.caption = this.var_188.localization.getKey(param1.localizationKey);
         _loc2_.height = _loc2_.textHeight + 5;
         this.var_216.y = this.var_188.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc1_:XmlAsset = this.var_188.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_188.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_367,false);
         _loc4_.height -= 20;
      ...
      {
         this.var_188.removeUpdateReceiver(this);
         this.var_188.registerUpdateReceiver(this,10);
      }
   }
}
