package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_429:String = "TUI_CLOTHES_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_37.events.addEventListener(HabboHelpTutorialEvent.const_650,this.onTaskDoneEvent);
         this.var_37.events.addEventListener(HabboHelpTutorialEvent.const_584,this.onTaskDoneEvent);
         this.var_37.events.addEventListener(HabboHelpTutorialEvent.const_568,this.onTaskDoneEvent);
         if(this.var_37.sessionDataManager != null)
         {
            this.var_37.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_315,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1259 && this.var_1258 && this.var_1535;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_37)
         {
            this.var_37.events.removeEventListener(HabboHelpTutorialEvent.const_650,this.onTaskDoneEvent);
            this.var_37.events.removeEventListener(HabboHelpTutorialEvent.const_584,this.onTaskDoneEvent);
            this.var_37.events.removeEventListener(HabboHelpTutorialEvent.const_568,this.onTaskDoneEvent);
            if(this.var_37.sessionDataManager != null)
            {
               this.var_37.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_315,this.onFigureUpdate);
            }
            this.var_37 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_52 == null || this.var_52.id == const_97)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_650:
               this.var_1535 = true;
               if(this.var_52 != null && this.var_52.id == const_555)
               {
                  this.showView(const_97);
               }
               break;
            case HabboHelpTutorialEvent.const_584:
               if(this.var_52 != null && this.var_52.id == const_429)
               {
                  this.var_1925 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2630 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2629;
         this._window.width = _loc2_.width + this.var_2630;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_37.hideUI();
         this.var_37.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_126));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_52 != null && (this.var_52.id == const_330 || this.var_52.id == const_97))
         {
            this.showView(const_97);
         }
      }
      ...
      {
         this.var_1259 = true;
         if(this.var_52 != null && (this.var_52.id == const_429 || this.var_52.id == const_97))
         {
            this.showView(const_97);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_591)
         {
            this.var_1258 = true;
