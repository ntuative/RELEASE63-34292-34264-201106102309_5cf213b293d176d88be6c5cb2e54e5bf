package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1399:int = 253;
      
      private static const const_1400:int = 10;
      ...
      override public function render() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            _loc1_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_9);
         }
      ...
      {
         main.showUI(HabboHelpViewEnum.const_213);
      }
