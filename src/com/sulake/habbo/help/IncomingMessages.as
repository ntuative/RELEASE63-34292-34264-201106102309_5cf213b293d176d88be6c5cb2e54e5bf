   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            {
               this.var_2530 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_23.tellUI(HabboHelpViewEnum.const_889);
      }
      ...
      {
         this.var_23.showUI(HabboHelpViewEnum.const_438);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this.var_23.tellUI(HabboHelpViewEnum.const_213);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_23.showUI(HabboHelpViewEnum.const_651);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_23.tellUI(HabboHelpViewEnum.const_358,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_23.tellUI(HabboHelpViewEnum.const_302,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_23.showUI(HabboHelpViewEnum.const_1233);
         this.var_23.tellUI(HabboHelpViewEnum.const_1233,_loc5_);
      }
