package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1981:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106102303));
         this.var_129 = new Map();
         this.var_129.add(HabboHelpViewEnum.const_1738,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_213,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_651,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_358,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_302,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_438,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_862,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_129.add(HabboHelpViewEnum.const_248,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_129.add(HabboHelpViewEnum.const_1166,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         ...
         this.var_129.add(HabboHelpViewEnum.const_889,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_562.length == 0 || param1 != this.var_390)
            {
               this.var_562.push(this.var_390);
            }
         }
         this.var_390 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_390);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_248:
               this.showUI(HabboHelpViewEnum.const_248);
               break;
            case CallForHelpResultEnum.const_1312:
               this.showUI(HabboHelpViewEnum.const_1247);
               break;
            case CallForHelpResultEnum.const_1319:
               this.showUI(HabboHelpViewEnum.const_1166);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_129.getValue(HabboHelpViewEnum.const_213) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_650));
      }
      ...
      {
         return this.var_129.getValue(this.var_390);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2630 = this._window.width - _loc3_.width;
         this.var_2629 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2629;
         this._window.width = _loc1_.width + this.var_2630;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_562.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_390 == HabboHelpViewEnum.const_213)
         {
            return;
         }
         if(this.var_684.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_684.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_684.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_391.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_684[1],this.var_684[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_684[0],this.var_684[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_390 == HabboHelpViewEnum.const_213 || this.var_562.length == 0)
         {
            return;
         }
         if(this.var_391 == null)
         {
            ...
            this.var_391 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_391.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_391.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_391 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_391 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_391 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
