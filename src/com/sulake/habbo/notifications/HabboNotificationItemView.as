package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_480:int = 70;
      
      public static const const_1787:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_575:int = 1;
      ...
      private var var_1369:uint;
      
      private var var_1370:uint;
      
      private var var_1664:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_2148 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_2148 = 15;
         }
         this.var_2147 = this._window.height;
         this.var_1663 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      {
         if(param1.badgeId != this.var_234.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_575:
               ...
               _loc2_ = Number(this.var_1369) / Number(this.var_1113["time_fade_in"]);
               if(this.var_1369 > int(this.var_1113["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1129:
               ...
               if(this.var_1664 > int(this.var_1113["time_display"]) && !this.var_2146)
               {
                  this.startFadeOut();
               }
               break;
            case const_1130:
               ...
               _loc3_ = 1 - Number(this.var_1370) / Number(this.var_1113["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1370 > int(this.var_1113["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2148;
         if(this._window.height < this.var_2147)
         {
            this._window.height = this.var_2147;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1787;
