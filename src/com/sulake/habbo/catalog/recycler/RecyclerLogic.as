package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_717 != const_1119;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2103 != RecyclerStatusMessageEvent.const_1280;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_717 == const_473;
      }
      ...
      {
         this.var_717 = const_1120;
         this.var_135 = new Array(const_224);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2103)
         {
            case RecyclerStatusMessageEvent.const_1723:
               this.var_717 = const_473;
            ...
            case RecyclerStatusMessageEvent.const_1280:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1910:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1350:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1901:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_135.length < const_224)
         {
            return false;
         }
         var _loc1_:int = 0;
