package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1470:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1491:XML;
      
      private static var var_1489:XML;
       
      
      private var var_1845:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3017:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1845 == 4294967295)
            {
               this.var_1845 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1740;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1742;
            }
         }
      }
      ...
      {
         this.var_64 = navigator.catalog.windowManager.buildFromXML(var_1489) as IItemListWindow;
         if(this.var_64 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1491) as IWindowContainer;
         }
         else
         {
