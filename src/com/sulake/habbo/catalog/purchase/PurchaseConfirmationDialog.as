package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2285:int = 10;
      ...
      private const const_1641:uint = 4.291613146E9;
      ...
      public function showOffer(param1:IHabboCatalog, param2:IRoomEngine, param3:IPurchasableOffer, param4:int, param5:String = "", param6:Array = null) : void
      {
         ...
         this.var_1285 = param3.offerId;
         this.var_1576 = param4;
         this.var_1578 = param5;
         this.var_248 = param6;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1285 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_352,this.onNameInputKeyUp);
         }
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_484,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1915 = _loc1_.stuffTypes;
            this.var_841 = _loc1_.boxTypes;
            this.var_842 = _loc1_.ribbonTypes;
            this.var_1284 = this.var_1915[0];
            this.var_395 = this.var_841[0];
            this.var_393 = this.var_842[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_393 < 0)
         {
            this.var_393 = this.var_842.length - 1;
         }
         if(this.var_393 > this.var_842.length - 1)
         {
            this.var_393 = 0;
         }
         if(this.var_395 < 0)
         {
            this.var_395 = this.var_841.length - 1;
         }
         if(this.var_395 > this.var_841.length - 1)
         {
            this.var_395 = 0;
         }
         var _loc1_:int = this.var_841[this.var_395] * 1000 + this.var_842[this.var_393];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1284,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1915)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc3_,ProductTypeEnum.const_70);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1284);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_841[this.var_395]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_842[this.var_393]);
         this._catalog.purchaseProductAsGift(this.var_1576,this.var_1285,this.var_1578,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1576,this.var_1285,this.var_1578);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2727 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_248)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2285)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2727 = _loc2_.text;
      }
      ...
      {
         if(this.var_289 == null || !this.var_289.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_289.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_289 == null)
         {
            this.var_289 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_843 == null)
         {
            this.var_843 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_289 == null || this.var_843 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_289.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_843.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_289.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         this.var_1284 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1284;
               }
            }
            _loc4_++;
         }
