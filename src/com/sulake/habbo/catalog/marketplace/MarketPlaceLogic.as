package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_2095:int = 1;
      
      public const const_2111:int = 2;
      
      public const const_2312:int = 3;
      ...
      private var var_2813:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_334);
            this.var_334 = null;
         }
         this._disposed = true;
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_194)
         {
            this.var_194 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_194.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2811,this.var_2810,this.var_2812,this.var_2814);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_2095,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_334.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_334.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_478)
            {
               this.var_334.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2759 = _loc3_.totalItemsFound;
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2339 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_334.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_2111,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_334.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2238 || param1.furniTypeId != this.var_2236)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1600)
               {
                  _loc2_ = true;
               }
            }
      ...
      public function getNameLocalizationKey(param1:IMarketPlaceOfferData) : String
      {
         ...
         if(param1 != null)
         {
            ...
            else if(param1.furniType == MarketPlaceOfferData.const_118)
            {
