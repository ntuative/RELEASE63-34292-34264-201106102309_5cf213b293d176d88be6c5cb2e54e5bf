package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1951:XML;
      
      private var var_1950:XML;
      
      private var var_232:IGridItem;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_676 = this.recycler.getPrizeTable();
         ...
         if(this.var_676.length > 0 && this.var_676[0].prizes.length > 0)
         {
            this.select(this.var_676[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_676.length)
         {
            this.createLevelItem(this.var_676[_loc2_]);
            _loc2_++;
         }
      }
      ...
      private function createPrizeItem(param1:PrizeContainer, param2:IItemGridWindow) : void
      {
         ...
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1951) as IWindowContainer;
