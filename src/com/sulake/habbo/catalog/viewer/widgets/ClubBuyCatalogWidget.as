package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubBuyCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      public function showOffer(param1:ClubBuyOfferData) : void
      {
         ...
         Logger.log("Offer: " + [offer.offerId,offer.method_2,offer.price,offer.upgrade,offer.vip,offer.periods,offer.daysLeftAfterPurchase,offer.year,offer.month,offer.day,offer.upgradeHcPeriodToVip]);
         offer.page = page;
         try
         {
