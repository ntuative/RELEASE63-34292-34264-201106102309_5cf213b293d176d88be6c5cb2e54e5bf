package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1086:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1086.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1086 = null;
         }
         if(this.var_1087 != null)
         {
            this.var_1087.removeEventListener(WindowKeyboardEvent.const_214,this.windowKeyEventProcessor);
            this.var_1087 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1086 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1086 != null)
         {
            this.var_1086.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1087 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1087 != null)
         {
            this.var_1087.addEventListener(WindowKeyboardEvent.const_214,this.windowKeyEventProcessor);
         }
         return true;
      }
