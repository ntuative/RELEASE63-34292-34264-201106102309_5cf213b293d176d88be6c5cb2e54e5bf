package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_588:IDisplayObjectWrapper;
      
      private var var_2141:Point;
      
      private var var_587:IItemGridWindow;
      
      private var var_1659:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1111 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1365 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_206 != null)
         {
            ...
            this.var_588 = this.var_206.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_588 != null && _loc3_ != null)
            {
               this.var_206.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_588.width,this.var_588.height);
               if(_loc4_ != null)
               {
                  this.var_588.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_2141 = new Point(this.var_99.x,this.var_99.y);
         this.var_587 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1659 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1111.text = _loc4_;
         this.var_1365.text = _loc5_;
         this.var_1111.height = this.var_1111.textHeight + 5;
         this.var_1365.y = this.var_1111.y + this.var_1111.height;
         this.var_1365.height = Math.max(130,this.var_1365.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_509:
                  ...
                  if(this.var_587 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_587,this.var_1659,this.var_1951);
                     this.var_587.scrollV = 0;
                  }
                  if(this.var_206 != null)
                  {
                     this.var_206.visible = false;
               ...
               case Offer.const_413:
                  ...
                  if(this.var_206 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_70 || _loc9_.productType == ProductTypeEnum.const_65 || _loc9_.productType == ProductTypeEnum.const_195)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_70:
                        if(_loc8_ != null && this.var_588 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_322,AvatarAction.const_556);
                                 _loc18_.appendAction(AvatarAction.const_338,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2957)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2957 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_99 != null && true)
         {
            ...
            this.var_99.x = this.var_2141.x;
            this.var_99.y = this.var_2141.y;
            if(param3 != null)
            {
