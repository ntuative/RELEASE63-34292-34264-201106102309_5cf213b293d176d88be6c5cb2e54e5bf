package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc6_)
         {
            _loc2_ = this.var_29.purse.pastVipDays >= this.const_239 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_29.purse.pastVipDays % this.const_239;
            _loc4_ = this.var_29.purse.pastVipDays / this.const_239;
            this.var_29.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_29.localization.registerParameter(_loc2_,"months",_loc4_.toString());
