package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      public function SongDiskProductViewCatalogWidget(param1:IWindowContainer, param2:IHabboSoundManager)
      {
         ...
         this.var_1282 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
         if(this.var_1282 != null)
         {
            this.var_1282.visible = false;
         }
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_123);
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_212);
            this._soundManager.musicController.playSong(this.var_1052,HabboMusicPrioritiesEnum.const_212,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_1052 = parseInt(_loc2_.extraParam);
            if(this.var_1282 != null)
            {
               this.var_1282.visible = true;
            }
         }
         else
         {
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_1052);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_1052);
         }
         return -1;
      }
