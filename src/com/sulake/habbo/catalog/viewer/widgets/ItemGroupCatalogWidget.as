package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_229[this.var_584][this.var_610];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_584 = var_501.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_584];
         var _loc3_:Array = this.var_229[this.var_584] as Array;
         ...
         events.dispatchEvent(new CatalogWidgetColoursEvent(_loc4_,"ctlg_clr_40x32_1","ctlg_clr_40x32_2","ctlg_clr_40x32_3",this.var_610));
      }
      
      override public function startDragAndDrop(param1:IGridItem) : Boolean
      {
         var _loc2_:Array = this.var_229[this.var_584] as Array;
         var _loc3_:Offer = _loc2_[this.var_610] as Offer;
         if(_loc3_ != null)
         {
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_610 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_610] as Offer;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var _loc1_:Array = this.var_229[this.var_584] as Array;
         var _loc2_:Offer = _loc1_[this.var_610] as Offer;
         var_232 = _loc2_.productContainer as ProductGridItem;
         var_232.activate();
      }
         ...
         for each(_loc1_ in page.offers)
         {
            if(_loc1_.pricingModel == Offer.const_439 || _loc1_.pricingModel == Offer.const_413)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_65 || _loc3_.productType == ProductTypeEnum.const_70)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_229[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
