package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1985:String = "ctlg_";
       
      
      protected var var_2202:XML;
      ...
      private var var_515:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1155:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_515 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1156);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1156);
      }
      ...
      {
         var _loc2_:String = const_1985 + param1;
         ...
         this.var_2202 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2202) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1705:
               if(this.var_1155 == null)
               {
                  this.var_1155 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_39.push(this.var_1155);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1954:
               ...
               break;
            case CatalogWidgetEnum.const_1684:
            ...
            case CatalogWidgetEnum.const_1851:
               ...
               break;
            case CatalogWidgetEnum.const_1687:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_515.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_515 != null)
         {
            return this.var_515.dispatchEvent(param1);
         }
         return false;
      }
