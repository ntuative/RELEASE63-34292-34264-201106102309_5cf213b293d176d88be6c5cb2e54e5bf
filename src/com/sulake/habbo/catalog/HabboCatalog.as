package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_687:uint = 1;
      ...
      private var var_1256:IRoomSession;
      ...
      private var var_221:CatalogViewer;
      
      private var var_381:ICatalogNavigator;
      ...
      private var var_222:ChargeConfirmationDialog;
      ...
      private var var_2627:Boolean = true;
      
      private var var_2628:Boolean = true;
      
      private var var_1923:Boolean = false;
      
      private var var_2626:GiftWrappingConfiguration;
      ...
      private var var_819:IPurchasableOffer;
      
      private var var_1534:IDragAndDropDoneReceiver;
      
      private var var_66:PlacedObjectPurchaseData;
      
      private var var_667:RoomPreviewer;
      
      private const const_2013:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_78,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            _loc2_ = this.var_382.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_194 == null || this.var_194.disposed)
            {
            ...
            this.var_194.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_382.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_152,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_191 != null && this.var_191.getKey("catalog.furniture.animation","false") == "UserTypingMessageEvent")
         {
            if(this.var_667 == null)
            {
               this.var_667 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_381.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_191.getKey("client.credits.embed.enabled","false") == "UserTypingMessageEvent";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_191.getKey("link.format.credits","/credits");
      ...
      {
         var _loc2_:Array = this.var_817.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_221.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_381 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_221 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_221.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_687) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2013;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_241,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_78:
               this.var_1923 = param1.session.isPrivateRoom;
               this.var_1256 = param1.session;
               if(this.var_103 != null)
               {
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_221 != null)
         {
            this.var_221.catalogWindowClosed();
         }
         if(this.var_103 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_103.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_381.buildCatalogIndex(_loc2_);
         if(this.var_818 && this.var_818 != "")
         {
            this.var_381.openPage(this.var_818);
            this.var_818 = "";
            this.var_1031 = -1;
         }
         else if(this.var_1031 > -1)
         {
            this.var_381.openPageById(this.var_1031,this.var_1922);
            this.var_1031 = -1;
            this.var_1922 = -1;
            this.var_818 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_221.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_221 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_221.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2627 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1345);
         }
         this.var_2627 = false;
         if(this.var_222 != null && !this.var_222.disposed)
         {
            this.var_222.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_74,this.var_116.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2628 && this._soundManager != null)
         {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2626 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_222 == null || this.var_222.disposed)
         {
            this.var_222 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_222.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_817.remove(_loc2_.method_2);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_817.add(_loc2_.method_2,_loc3_.slice());
            this.var_221.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.method_2,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "UserTypingMessageEvent" == this.var_191.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_191.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_179)
         {
            _loc3_ = this.var_191.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_191.keyExists("catalog.drag_and_drop") || this.var_191.getKey("catalog.drag_and_drop") != "UserTypingMessageEvent")
         {
            return false;
         }
         if(!this.var_1256 || !this.var_1256.isRoomOwner)
         {
            return false;
         }
         ...
         switch(_loc2_.productType)
         {
            case ProductTypeEnum.const_195:
               _loc3_ = false;
               break;
            case ProductTypeEnum.const_313:
               _loc3_ = false;
         }
         return _loc3_;
      }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1254 && param1.type == RoomEngineObjectEvent.const_152)
         {
            this.resetPlacedOfferData(true);
            if(this.var_819 == null || this.var_819.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_819.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_66 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_819);
            _loc5_ = this.var_1534;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_357,0.5);
            }
         }
      }
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_191.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_687);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_667 != null)
         {
            this.var_667.updatePreviewRoomView();
         }
      }
   }
}
