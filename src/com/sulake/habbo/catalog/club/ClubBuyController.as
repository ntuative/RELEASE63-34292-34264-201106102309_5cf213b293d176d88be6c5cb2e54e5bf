package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyController
   {
      ...
      private var var_194:ClubBuyConfirmationDialog;
      ...
      public function onOffers(param1:HabboClubOffersMessageEvent) : void
      {
         ...
         {
            _loc6_ = new ClubBuyOfferData(_loc5_.offerId,_loc5_.method_2,_loc5_.price,_loc5_.upgrade,_loc5_.vip,_loc5_.periods,_loc5_.daysLeftAfterPurchase,_loc5_.year,_loc5_.month,_loc5_.day);
      ...
      {
         this.closeConfirmation();
         this.var_194 = new ClubBuyConfirmationDialog(this,param1,param2);
      }
