package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_104.productContainer.initProductIcon(this.var_29.roomEngine);
      }
      ...
      {
         if(!param1 || !param2 || !this.var_29 || !this.var_104)
         {
            return;
         }
         ...
         {
            case "select_button":
               this.var_29.confirmSelection(this.var_104.localizationId);
               break;
