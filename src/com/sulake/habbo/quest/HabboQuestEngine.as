package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1424:int = 5;
      
      private static const const_1426:int = 800;
      
      private static const const_1423:int = 15;
      
      private static const const_1425:int = 300;
      ...
      private var var_1173:QuestController;
      
      private var var_954:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1173 = new QuestController(this);
         this.var_954 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1424);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_382.events.removeEventListener(BadgeImageReadyEvent.const_117,this.var_954.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_382.events.addEventListener(BadgeImageReadyEvent.const_117,this.var_954.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1173.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_954.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1173.questTracker.isVisible();
      }
      ...
      {
         this.var_1173.update(param1);
         this.var_954.update(param1);
      }
