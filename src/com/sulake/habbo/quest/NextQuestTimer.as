package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      private static const const_1421:int = 1000;
      
      private static const const_1420:int = 115;
      
      private static const const_1419:int = 25;
      
      private static const const_1025:int = 72;
      ...
      {
         var _loc1_:int = this.var_121.getRemainingTimeInSecs();
         if(_loc1_ < 1)
         {
            this.close();
            this.var_121.waitPeriodSeconds = 0;
            this._questEngine.questController.onQuest(this.var_121);
         }
         var _loc2_:String = FriendlyTime.getFriendlyTime(this._questEngine.localization,_loc1_);
         var _loc3_:* = this.var_121.getCampaignLocalizationKey() + ".delayedmsg";
         ...
         this._window.findChildByName("quest_header_txt").caption = this._questEngine.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_437 ? "expanded" : "contracted"));
      ...
      {
         this._window.findChildByName("quest_timer_expanded").visible = this.var_437;
         this._window.findChildByName("quest_timer_contracted").visible = !this.var_437;
         this._window.findChildByName("more_info_txt").visible = this.var_437 && this._questEngine.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_437 && this._questEngine.currentlyInRoom;
         this._window.findChildByName("quest_pic_bitmap").visible = this.var_437;
         this._window.findChildByName("desc_txt").visible = this.var_437;
         this._questEngine.notifications.setQuestTrackerHeight(!!this.var_437 ? int(const_1420) : int(const_1419));
         this.refresh();
      }
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this._questEngine.questController.questDetails.showDetails(this.var_121);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1448 = const_1421;
         this.refresh();
      }
      
      private function getDefaultLocationX() : int
      {
         return this._window.desktop.width - this._window.width - const_1422;
      }
