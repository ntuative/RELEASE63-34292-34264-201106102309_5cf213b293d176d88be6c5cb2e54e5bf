package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_723:RoomInfoViewCtrl;
      
      private var var_1368:RoomCreateViewCtrl;
      ...
      private var var_1102:GuestRoomPasswordInput;
      
      private var var_309:GuestRoomDoorbell;
      
      private var var_1367:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2965 = new Array();
         ...
         this.var_723 = new RoomInfoViewCtrl(this);
         this.var_1368 = new RoomCreateViewCtrl(this);
         this.var_2725 = new RoomThumbnailRenderer(this);
         this.var_1102 = new GuestRoomPasswordInput(this);
         this.var_309 = new GuestRoomDoorbell(this);
         this.var_427 = new Tabs(this);
         this.var_1367 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_324,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_344.startSearch(Tabs.const_208,Tabs.const_389,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_344.startSearch(Tabs.const_245,Tabs.const_269);
         this.var_427.getTab(Tabs.const_245).tabPageDecorator.tabSelected();
      }
