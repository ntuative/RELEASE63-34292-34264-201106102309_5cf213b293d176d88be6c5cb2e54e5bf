package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_545:int = 10;
      
      private static const const_1033:int = 32;
      
      private static const const_1445:int = 8;
      
      private static const const_1446:int = -16;
      
      private static const const_1447:int = 40;
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_1033 / 2);
         return new Point(param1 * const_1033 + _loc3_,param2 * const_1445);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_324,HabboWindowStyle.const_46,0 | (!!param3 ? HabboWindowParam.const_43 : HabboWindowParam.const_46),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_971.getImage(ThumbnailEditorModel.const_36,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_971.getImage(ThumbnailEditorModel.const_36,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_971.getImage(ThumbnailEditorModel.const_62,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_971.getImage(ThumbnailEditorModel.const_34,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1446,_loc4_.y + const_1447 - _loc5_.height),null,null,true);
      }
