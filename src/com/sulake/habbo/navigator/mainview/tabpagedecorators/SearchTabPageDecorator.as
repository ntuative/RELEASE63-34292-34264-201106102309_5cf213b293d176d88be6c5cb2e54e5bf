package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2125:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_2125 == null)
         {
            ...
            this.var_2125 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_2125.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_389)
            {
      ...
      {
         this._navigator.mainViewCtrl.startSearch(Tabs.const_208,Tabs.const_242,"-1",MainViewCtrl.const_732);
      }
