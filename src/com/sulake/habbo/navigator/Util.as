package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1575:CutToWidth = new CutToWidth();
      
      private static var var_2726:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1575.beforeSearch(param2,param1,param3);
         binarySearch(var_1575,param2.length - 1);
      }
