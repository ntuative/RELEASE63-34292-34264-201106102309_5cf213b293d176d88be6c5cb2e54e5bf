package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_604.stop();
            this.var_604.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_604 = null;
         }
         ...
         if(this.var_1053)
         {
            this.var_1053.release(new IIDHabboNotifications());
            this.var_1053 = null;
         }
         if(this._toolbar)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1699 = new OpenedToWebPopup(this);
         }
         this.var_1699.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_421);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_324,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_901.createAvatarImage(param1,AvatarScaleType.const_109,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_191.getKey("client.minimail.embed.enabled");
         return _loc1_ == "UserTypingMessageEvent";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_191.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_1053 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_167 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_114.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_114.addCategory(new FriendCategory(FriendCategory.const_1371,this.getText("friendlist.friends")));
         this.var_114.addCategory(new FriendCategory(FriendCategory.const_448,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_604)
         {
            this.var_604 = new Timer(120000);
            this.var_604.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_604.start();
         }
         ...
         {
            _loc5_ = this.var_114.findCategory(FriendCategory.const_448);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_167.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_167.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_427.findTab(FriendListTab.const_103).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_167.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_427.findTab(FriendListTab.const_103);
      ...
      private function onAcceptBuddyResult(param1:IMessageEvent) : void
      {
         ...
         for each(_loc3_ in _loc2_.method_14)
         {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1698.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_427.findTab(FriendListTab.const_103);
         if(!_loc2_)
         {
            return;
         }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         {
            _loc2_ = this.var_167.vipLimit;
         }
         else if(this.var_742.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_38))
         {
            _loc2_ = this.var_167.clubLimit;
         }
         if(_loc2_ > this.var_167.limit)
         {
            this.var_167.limit = _loc2_;
         }
      }
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_186) as IBitmapWrapperWindow;
