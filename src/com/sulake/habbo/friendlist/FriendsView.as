package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2083:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2268:IContainerButtonWindow;
      
      private var var_2269:IContainerButtonWindow;
      
      private var var_2271:IContainerButtonWindow;
      
      private var var_2270:IContainerButtonWindow;
      
      private var var_64:IItemListWindow;
      
      private var var_664:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_664 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2268 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2269 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2271 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2270 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2268,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2269,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2271,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2270,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_664.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_664.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_664.closePopup();
         }
