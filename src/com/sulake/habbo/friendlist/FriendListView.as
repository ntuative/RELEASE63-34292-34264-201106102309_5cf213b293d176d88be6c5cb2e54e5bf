package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1450:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2097:FriendListTabsView;
      ...
      private var var_1632:ITextWindow;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2097 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1450;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_923 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_298 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_2097.prepare(this.var_923);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1176,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1183,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_885,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_784,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_885,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_784,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1632 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1632.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2100 == -1 ? 0 : int(this.var_17.height - this.var_2100);
         var _loc4_:int = this.var_2098 == -1 ? 0 : int(this.var_17.width - this.var_2098);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_298.y = Util.getLowestPoint(this.var_17.content);
         this.var_298.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1132,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_885,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1176,false);
         ...
         this.var_2100 = this.var_17.height;
         this.var_2098 = this.var_17.width;
