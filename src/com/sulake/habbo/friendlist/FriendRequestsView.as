package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2042:String = "no_reqs_info";
      ...
      private var var_2152:IContainerButtonWindow;
      ...
      {
         this.var_2152 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2153 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2153.procedure = this.onDismissAllButtonClick;
         this.var_2152.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_103,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1208)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_390 && _loc4_.state != FriendRequest.const_432)
            {
               _loc4_.state = FriendRequest.const_432;
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2152,_loc1_);
         this.setEnabled(this.var_2153,_loc1_);
      }
