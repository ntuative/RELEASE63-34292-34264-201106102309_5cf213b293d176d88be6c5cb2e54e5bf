package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_448:int = -1;
      ...
      {
         var _loc4_:* = null;
         if(this.var_248.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_248[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_248.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_248,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_1065 >= this.getPageCount())
         {
            this.var_1065 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_248.length / const_402);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_1065 * const_402;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_1065 + 1) * const_402,this.var_248.length);
      }
