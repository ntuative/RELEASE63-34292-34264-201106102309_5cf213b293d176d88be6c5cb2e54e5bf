package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2079:int = "F".charCodeAt(0);
      
      public static const const_2104:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1921 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1755 = param1.motto;
         this.var_1753 = param1.lastAccess;
         this.var_1461 = param1.categoryId;
