package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_476:Conversations;
      
      private var var_199:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_191 && this._localization && this._friendList && this.var_901 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_476 = new Conversations(new ConversationsDeps(this));
         this.var_199 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_476.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_476.setSelected(_loc2_);
            this.var_199.openMessenger();
            this.var_199.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_476 ? this.var_476.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_476.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_476.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         return this.var_199 && this.var_199.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_199)
         {
            if(this.var_199.isMessengerOpen())
            {
               this.var_199.close();
            }
            else
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_191.getKey("url.prefix",_loc2_);
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_928,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1309,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_476.addMessageAndUpdateView(param1);
         if(!this.var_199.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         this.var_476.addMessageAndUpdateView(_loc3_);
      }
