package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1128:int = 100;
      ...
      private var var_2958:IScrollbarWindow;
      
      private var var_2142:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_143 = param1;
         this.var_2142 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_64 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2958 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1128 + const_1676)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1677;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_2142.enable();
         }
         else
         {
            this.var_2142.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_64.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_589.messages.length - const_1128);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_929 || param3.type == Message.const_928 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_143.send(new FollowFriendMessageComposer(this.var_589.id));
         this.var_143.send(new EventLogMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_883)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1309)
         {
            return 4288269465;
         }
         return 4291611852;
