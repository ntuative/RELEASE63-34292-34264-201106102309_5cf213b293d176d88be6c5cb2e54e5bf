package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1588:int = 60;
      
      private static const const_1587:int = 25165823;
      
      private static const const_1586:int = 16777215;
      ...
      private var var_944:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_742,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1054.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1200:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1904:
               ...
               case HabboSoundTypesEnum.const_1344:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1345:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_1712:
            ...
            this.var_1054.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_944;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_687.add(_loc4_,param1);
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_290,events);
         _loc5_.volume = this.var_944;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_290.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1053.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1053 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_191 == null || this._connection == null || this._roomEngine == null || this.var_247 != null)
         {
            return;
         }
         this.var_247 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_247.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1686,this.var_846));
         this.var_846 = -1;
         this.var_847 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_944 * 100)));
         }
      }
      ...
      {
         this.var_944 = param1;
         this.var_247.updateVolume(this.var_944);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_687.getValue(param1) != null)
         {
            _loc2_ = this.var_687.remove(param1);
            if(this.var_290.getValue(_loc2_) == null)
            {
               this.var_1582.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1582,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1582,_loc2_,TraxSample.const_1739,TraxSample.const_1763);
               this.var_290.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         if(this.var_1291.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1588 && this.var_1291.length > 0)
            {
               _loc3_ = this.var_1291.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_687.length == 0 && this.var_846 != -1)
            {
               this.var_847.ready = true;
               _loc4_ = this.var_846;
               this.var_846 = -1;
               this.var_847 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_742,_loc4_));
               if(this.var_2731)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_847 == null && this.var_1290.length > 0)
         {
            ...
            if(_loc2_ != null && !_loc2_.disposed)
            {
               ...
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_742,_loc1_));
               }
               else
               {
                  this.var_847 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_247.samplesIdsInUse;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_290.length)
         {
            _loc5_ = this.var_290.getKey(_loc4_);
            _loc6_ = this.var_290.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1587)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1586 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_290.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_290.remove(_loc11_);
               }
               this.var_247.samplesUnloaded(_loc7_);
            }
         }
      }
