package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_247:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_247 = param2;
         this.var_751 = [];
         this.var_751.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_751.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_751)
         {
         ...
         this.var_88.addEventListener(RoomEngineSoundMachineEvent.const_726,this.onSoundMachinePlayEvent);
         this.var_88.addEventListener(RoomEngineSoundMachineEvent.const_844,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_88)
            {
               this.var_88.removeEventListener(RoomEngineSoundMachineEvent.const_726,this.onSoundMachinePlayEvent);
               this.var_88.removeEventListener(RoomEngineSoundMachineEvent.const_844,this.onSoundMachineStopEvent);
               this.var_88 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_485);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_247.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_485 = -1;
         this.var_708 = false;
         this.var_247.stop(HabboMusicPrioritiesEnum.const_123);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_247.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_247.playSong(param1,HabboMusicPrioritiesEnum.const_123,_loc3_,0,0,0))
         {
