package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1209:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2565:IStructureData;
      
      private var var_1882:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         this.var_2565.appendXML(this.var_1882);
         dispatchEvent(new Event(AvatarStructureDownload.const_1209));
      }
