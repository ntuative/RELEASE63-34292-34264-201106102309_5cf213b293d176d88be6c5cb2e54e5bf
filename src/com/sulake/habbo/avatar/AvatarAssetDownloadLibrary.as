package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1907:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1248 = param3 + this.var_813 + ".swf";
         this.var_1248 = this.var_1248.replace("%revision%",this._revision);
      ...
      {
         this._state = var_1907;
         var _loc1_:URLRequest = new URLRequest(this.var_1248);
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_813 + " from URL " + this.var_1248,false,Core.const_1299);
      }
