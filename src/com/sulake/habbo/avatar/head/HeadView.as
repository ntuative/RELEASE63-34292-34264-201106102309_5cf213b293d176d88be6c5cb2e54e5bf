   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_225,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_291,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_279,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_255,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_250,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_76 && var_163 == "")
         {
            var_76.switchCategory(FigureData.const_225);
         }
      }
