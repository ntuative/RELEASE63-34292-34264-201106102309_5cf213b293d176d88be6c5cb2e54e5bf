package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_296:AvatarImageCache;
      ...
      private var var_595:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1572);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_306.definition.geometryType);
         if(this.var_47 == null || _loc4_ != null && (this.var_47.width != _loc4_.width || this.var_47.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_306.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_556 = this.var_556 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_399:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1713:
                  case AvatarAction.const_1726:
                  case AvatarAction.const_1783:
                  case AvatarAction.const_1202:
                  case AvatarAction.const_1181:
                  case AvatarAction.const_1831:
                  case AvatarAction.const_1706:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_351.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1050);
         this.getCache().resetBodyPartCache(this.var_1050);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1573 = this._structure.sortActions(this.var_351);
         ...
         {
            this.var_888 = this._structure.getCanvasOffsets(this.var_1573,this._scale,this.var_100);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1573)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_370)
               {
                  this.var_996 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1331 = _loc4_.id;
                     this.var_1986 = _loc4_.breed;
                     break;
                  }
               }
            }
