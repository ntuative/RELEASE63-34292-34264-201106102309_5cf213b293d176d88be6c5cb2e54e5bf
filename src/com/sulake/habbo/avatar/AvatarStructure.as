package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_461:AvatarRenderManager;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_959:AvatarActionManager;
      
      private var var_363:FigureData;
      
      private var var_439:PartSetsData;
      
      private var _animationData:AnimationData;
      
      private var var_765:AnimationManager;
      
      private var var_1050:ActionDefinition;
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_959 = new AvatarActionManager(param1,this.var_522,param2);
         this.var_1050 = this.var_959.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         {
            if(this.var_522 == AvatarType.const_124)
            {
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         ...
         return this.var_363.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_363.injectXML(param1);
      }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_765.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_363.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_363.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_765.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_765.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_959.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_959.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_959.sortActions(param1);
      }
      
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(!this.var_629[param1])
         {
            this.var_629[param1] = new Dictionary();
         }
         if(this.var_629[param1][param2])
         {
            return this.var_629[param1][param2];
         }
         this.var_629[param1][param2] = this.var_363.getMandatorySetTypeIds(param1,param2);
         return this.var_629[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_363.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_959.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_765.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1970[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_765.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_363.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_363.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
