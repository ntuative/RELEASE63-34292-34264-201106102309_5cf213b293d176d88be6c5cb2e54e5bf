package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2286:String = "hd-99999-99999";
      ...
      private var var_850:PaletteManager;
      ...
      private var var_2000:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_350 = RenderMode.const_1846;
         ...
         this.var_117.add(AvatarType.const_124,_loc4_);
         ...
         this.var_117.add(AvatarType.const_56,_loc4_);
         ...
         this.var_850 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_245)
         {
            this.var_245.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_331.init();
         this.var_850.init();
         _loc2_ = this.var_117.getValue(AvatarType.const_124) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_117.getValue(AvatarType.const_56) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_117.getValue(AvatarType.const_124) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_191.getKey("external.figurepartlist.txt","figure.xml");
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1209,this.onFigureDataDownloadDone);
               if(this.var_245 == null)
               {
                  Logger.log("[AvatarRenderManager] Init Avatar Assets Download Manager");
                  _loc6_ = this.var_191.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_191.getKey("flash.dynamic.avatar.download.url","");
                  this.var_245 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_245.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1004)
         {
            if(this.var_2743 && this.var_2741 && this.var_2742)
            {
               this.var_1004 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_245.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_245.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_117.getValue(AvatarType.const_124) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_245.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2000)
         {
            this.var_2000 = new AvatarFigureContainer(this.const_2286);
         }
         this.var_245.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2000,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(param1 == null || this.var_330 == null)
         {
            return;
         }
         for each(_loc2_ in this.var_330.getKeys())
         {
            _loc3_ = this.var_330.getValue(_loc2_);
            if(_loc3_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_331.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1876)
         {
            _loc6_ = !this.var_331.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_331.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_117.getValue(AvatarType.const_56) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_330.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_117.getValue(AvatarType.const_56);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_330.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_330.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_117.getValue(AvatarType.const_124) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_56:
               _loc3_ = this.var_117.getValue(AvatarType.const_56) as AvatarStructure;
               break;
            default:
