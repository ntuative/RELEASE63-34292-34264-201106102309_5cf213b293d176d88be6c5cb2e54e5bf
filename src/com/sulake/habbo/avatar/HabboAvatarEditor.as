package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1468:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1467:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_540:HabboAvatarEditorManager;
      
      private var var_994:IFigureData;
      ...
      private var var_1214:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_540 = param2;
         this.var_994 = this.var_540.avatarRenderManager.getFigureData(AvatarType.const_124);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_651["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_651["null"];
         var _loc3_:FigureData = this.var_651["null"];
         _loc2_.loadAvatarData(const_1468,FigureData.const_93);
         _loc3_.loadAvatarData(const_1467,FigureData.FEMALE);
         this.var_114 = new Map();
         this.var_539 = new Map();
         this.var_114.add(AvatarEditorFigureCategory.const_794,new BodyModel(this));
         this.var_114.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
         this.var_114.add(AvatarEditorFigureCategory.const_283,new TorsoModel(this));
         this.var_114.add(AvatarEditorFigureCategory.const_903,new LegsModel(this));
         ...
         this.var_539.add(AvatarEditorSideCategory.const_108,new WardrobeModel(this));
         this.var_539.add(AvatarEditorSideCategory.const_648,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_794 != param3)
         {
            this.var_794 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_651[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_994.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_994.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_539.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_651[this.var_1056];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1214.saveFigure(_loc1_,_loc2_);
         }
         else
         {
            _loc3_ = new UpdateFigureDataMessageComposer(_loc1_,_loc2_);
            this.var_540.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1838;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_794 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_676)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_540.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_540.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_540.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
                  _loc22_ = (_loc21_.content as BitmapData).clone();
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1383.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1934)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_794 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1383.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_540.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_794 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_539.getValue(AvatarEditorSideCategory.const_108);
      }
