   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_92,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_76.controller.gender)
         {
            case FigureData.const_93:
               activateTab(this.const_707);
               inactivateTab(this.const_708);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_708);
               inactivateTab(this.const_707);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_707:
                  var_76.controller.gender = FigureData.const_93;
