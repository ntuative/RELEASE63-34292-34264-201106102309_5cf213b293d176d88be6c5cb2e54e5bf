package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1553:String = "Default";
      
      private static const const_1552:int = 2;
      
      private static const const_1554:String = AvatarSetType.const_41;
      ...
      protected var var_306:IActiveActionData;
      
      protected var var_1123:Boolean;
      
      protected var var_888:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_296:AvatarImageCache;
      
      protected var _figure:AvatarFigureContainer;
      
      protected var var_595:IAvatarDataContainer;
      
      protected var var_351:Array;
      
      protected var var_47:BitmapData;
      
      private var var_1050:IActiveActionData;
      ...
      protected var var_1398:Boolean = false;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this._figure = param3;
         this.var_296 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1554,const_1552);
         this.var_351 = new Array();
         this.var_1050 = new ActiveActionData(AvatarAction.const_419);
         this.var_1050.definition = this._structure.getActionDefinition(const_1553);
         this.resetActions();
      ...
      {
         param2 += this.var_1918;
         if(param2 < AvatarDirectionAngle.const_1277)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_281.length == 1 && this.var_100 == this.var_2135)
         {
            return this.var_100 + this.var_556 + this.var_665 % 4;
         }
         if(this.var_281.length == 2)
         {
      ...
      {
         if(param3 != this.var_2623 || param2 != this.var_2622 || param1 != this.var_2624)
         {
            this.var_2623 = param3;
            this.var_2622 = param2;
            this.var_2624 = param1;
            this.var_1919 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_306.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1398 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1398)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_306.definition.geometryType,this.var_100);
         this.var_47.lock();
         ...
         {
            if(this.var_595.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc13_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_595.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_306.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_306.definition.geometryType,this.var_100);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_351.length)
         {
            _loc3_ = this.var_351[_loc4_];
         ...
         this.var_351.push(new ActiveActionData(param1,param2,this.var_665));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_306 = this.var_1050;
         this.var_306.definition = this.var_1050.definition;
         this.resetBodyPartCache(this.var_1050);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_281)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_556 = "";
         this.var_281 = this._structure.sortActions(this.var_351);
         if(this.var_281 == null)
         {
            this.var_888 = new Array(0,0,0);
            if(this.var_1249 != "")
            {
               _loc1_ = true;
               this.var_1249 = "";
         ...
         {
            this.var_888 = this._structure.getCanvasOffsets(this.var_281,this._scale,this.var_100);
            for each(_loc4_ in this.var_281)
            {
               this.var_556 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_338)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1530 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1249 != this.var_556)
            {
               _loc1_ = true;
               this.var_1249 = this.var_556;
            }
         }
         this.var_1531 = true;
         return _loc1_;
         ...
         for each(_loc1_ in this.var_281)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     this.var_225 = this.var_225.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1918 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_595 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_370 || _loc1_.actionType == AvatarAction.const_287 || _loc1_.actionType == AvatarAction.const_409)
               {
                  this.var_996 = true;
               }
            }
