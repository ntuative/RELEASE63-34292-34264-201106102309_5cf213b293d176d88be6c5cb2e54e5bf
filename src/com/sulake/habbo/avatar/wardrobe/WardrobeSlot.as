package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this._figure && this.var_1584)
         {
            _loc5_ = this.var_29.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_109,this.var_1056,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_41,parseInt(FigureData.const_979));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1584 && this._figure != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this._figure = this.var_29.figureData.getFigureString();
               this.var_1056 = this.var_29.gender;
               this.var_29.handler.saveWardrobeOutfit(this.var_2001,this);
               this.updateView();
               break;
            case "get_button":
               if(this._figure)
               {
                  this.var_29.loadAvatarInEditor(this._figure,this.var_1056,this.var_29.clubMemberLevel);
               }
         }
      }
