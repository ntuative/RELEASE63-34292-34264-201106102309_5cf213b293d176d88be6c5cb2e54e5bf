package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements ISideContentModel
   {
      ...
      private function init() : void
      {
         ...
         while(_loc1_ <= 10)
         {
            this.var_576.add(_loc1_,new WardrobeSlot(this.var_29,_loc1_,this.isSlotEnabled(_loc1_)));
            _loc1_++;
         }
         if(this._view)
         {
      ...
      public function updateSlots(param1:int, param2:Array) : void
      {
         ...
         {
            _loc3_ = this.var_576.getValue(_loc4_.slotId) as WardrobeSlot;
            if(_loc3_)
            {
      ...
      private function isSlotEnabled(param1:int) : Boolean
      {
         ...
         return this.var_29.manager.sessionData.hasUserRight("fuse_larger_wardrobe",HabboClubLevelEnum.const_47);
      }
      
      public function get slots() : Array
      {
         return this.var_576.getValues();
      }
   }
}
