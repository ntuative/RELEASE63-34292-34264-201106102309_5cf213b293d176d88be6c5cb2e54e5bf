package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_1991 = parseInt(param2.@ink);
         this.var_2676 = String(param2.@member);
         this.var_2675 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1553 = [];
         this.var_1552 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1553[_loc4_] = parseInt(_loc3_.@dy);
      ...
      {
         if(param1 < this.var_1553.length)
         {
