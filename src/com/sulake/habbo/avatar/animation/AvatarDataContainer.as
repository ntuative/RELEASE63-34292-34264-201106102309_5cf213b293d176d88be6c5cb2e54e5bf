package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2108:Number = 1.0;
      
      private var var_2111:Number = 1.0;
      
      private var var_2110:Number = 1.0;
      ...
      {
         super();
         this.var_1991 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2729 = parseInt(_loc2_,16);
         this.var_2728 = parseInt(_loc3_,16);
         ...
         this.var_766 = new ColorTransform(this.var_2108,this.var_2111,this.var_2110,this._alphaMultiplier);
         this.var_1288 = this.generatePaletteMapForGrayscale(this.var_2728,this.var_2729);
      }
      ...
      {
         return this.var_1288.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1288.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1288.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1288.getValue("alphas") as Array;
      }
