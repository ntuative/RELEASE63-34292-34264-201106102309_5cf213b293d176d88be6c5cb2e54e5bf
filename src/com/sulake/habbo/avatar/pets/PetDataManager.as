package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(this.var_428.getValue(_loc4_) == null)
               {
                  this.var_428.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_513 == null)
         {
            return;
         }
         var _loc2_:int = this.var_513.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_513.splice(_loc2_,1);
         }
      }
      ...
      {
         var _loc1_:* = null;
         while(this.var_513.length > 0)
         {
            _loc1_ = this.var_513.pop() as IPetDataListener;
      ...
      {
         var _loc3_:IPetData = this.var_428.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
      ...
      public function createPetFigureString(param1:int, param2:int, param3:uint) : String
      {
         ...
         var _loc4_:PetData = this.var_428.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = this.var_428.getKeys();
         for each(key in speciesKeys)
         {
            petData = this.var_428.getValue(key);
            if(petData != null)
            {
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1418.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_606.getValue(_loc6_) == null)
               {
                  ...
                  this.var_606.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_513.indexOf(param3) == -1)
                  {
                     this.var_513.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_606.getKeys())
         {
            _loc5_ = this.var_606.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_303.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
            this.var_303.splice(_loc3_,1);
