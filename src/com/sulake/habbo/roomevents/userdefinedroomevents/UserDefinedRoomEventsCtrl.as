package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_347:int = 3;
      
      private static var var_1445:int = 2;
      ...
      private var var_1759:TriggerConfs;
      
      private var var_1760:ActionTypes;
      
      private var var_1758:ConditionTypes;
      
      private var var_264:Dictionary;
      
      private var var_38:Triggerable;
      
      private var var_760:RoomObjectHightLighter;
      
      private var var_188:UserDefinedRoomEventsHelp;
      
      private var var_1169:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1759 = new TriggerConfs();
         this.var_1760 = new ActionTypes();
         this.var_1758 = new ConditionTypes();
         this.var_264 = new Dictionary();
         super();
         this.var_88 = param1;
         this.var_760 = new RoomObjectHightLighter(param1);
         this.var_188 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_55 = IWindowContainer(this.find(this._window,"configure_container"));
         Util.setProcDirectly(this.find(this.var_55,"save_button"),this.onSave);
         Util.setProcDirectly(this.find(this.var_55,"cancel_save_button"),this.onWindowClose);
         Util.setProcDirectly(this.find(this.var_55,"helplink"),this.onHelp);
         Util.setProcDirectly(this.find(this.var_55,"apply_snapshot_txt"),this.onApplySnapshot);
         Util.setProcDirectly(this.find(this.var_55,"dec_stuff_sel_txt"),this.onDecStuffSelectionType);
         Util.setProcDirectly(this.find(this.var_55,"inc_stuff_sel_txt"),this.onIncStuffSelectionType);
         this.find(this.var_55,"dec_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_55,"inc_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_55,"helplink").mouseThreshold = 0;
         this.find(this.var_55,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1169 = new SliderWindowController(this.var_88,IWindowContainer(this.find(this.var_55,"delay_slider_container")),this.var_88.assets,0,20,1);
         this.var_1169.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1169.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_760.hideAll(this.var_264);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_760.showAll(this.var_264);
         if(this.var_38 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_38);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1169.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_38.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_347)
            {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(this.var_55.findChildByName("select_furni_container"));
         _loc1_.height = Util.getLowestPoint(_loc1_);
      }
      
      private function refreshStuffTypeSelectionToggler() : void
      {
         this.getFurniTypeMatchesText().caption = this.var_88.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_38.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_38 as TriggerDefinition != null)
         {
            this.var_88.send(new UpdateTriggerMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_38 as ActionDefinition != null)
         {
            this.var_88.send(new UpdateActionMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_38 as ConditionDefinition != null)
         {
            this.var_88.send(new UpdateConditionMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1169.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_188.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1445) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1445 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_88.send(new ApplySnapshotMessageComposer(this.var_38.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_347)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1759);
         this.refreshConfigureElement(this.var_1760);
         this.refreshConfigureElement(this.var_1758);
      ...
      private function refreshConfigureElement(param1:ElementTypeHolder) : void
      {
         ...
         {
            this.find(this.var_55,param1.getKey() + "_icon_bitmap").visible = false;
            return;
         }
         ...
         this.find(this.var_55,"warning_container").visible = false;
         this.refreshConflictingTriggers();
         this.refreshConflictingActions();
         this.refreshActionInputs();
         Util.moveAllChildrenToColumn(this.var_55,3,5);
         this.var_55.height = Util.getLowestPoint(this.var_55) + 1;
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_55,"header_container"));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_55,"action_inputs_container"));
         if(this.var_38 as ActionDefinition == null)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_55,"warning_container"));
         ...
         _loc3_.height = Util.getLowestPoint(_loc3_) + 4;
         this.find(this.var_55,"warning_container").visible = true;
      }
      
      private function refreshCustomInputs() : void
      {
         var _loc2_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_55.findChildByName("custom_inputs_container"));
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         var _loc2_:Element = this.resolveType();
         var _loc3_:IWindowContainer = IWindowContainer(this.var_55.findChildByName("custom_inputs_container"));
      ...
      {
         return ICheckBoxWindow(this.var_55.findChildByName("furni_type_matches_checkbox"));
      }
      
      private function getDecStuffSelTxt() : IWindow
      {
         return this.var_55.findChildByName("dec_stuff_sel_txt");
      }
      
      private function getIncStuffSelTxt() : IWindow
      {
         return this.var_55.findChildByName("inc_stuff_sel_txt");
      }
      
      private function getFurniTypeMatchesText() : IWindow
      {
         return this.var_55.findChildByName("furni_type_matches_txt");
      }
   }
}
