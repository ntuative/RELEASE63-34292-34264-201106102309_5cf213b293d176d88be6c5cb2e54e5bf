package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_88.roomEngine.getRoomObject(this.var_88.roomId,this.var_88.roomCategory,param1,RoomObjectCategoryEnum.const_27);
      }
