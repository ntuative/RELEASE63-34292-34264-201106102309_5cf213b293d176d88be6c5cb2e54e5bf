package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1326:Number = 1.0;
      
      private var var_709:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1326,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1076);
         }
      ...
      {
         return int(this.var_1967 * (Number(param1 - this._minValue) / (this.var_1326 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1967 * (this.var_1326 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1077)
         {
            if(param1.type == WindowMouseEvent.const_57 || param1.type == WindowMouseEvent.const_247)
            {
               this.var_1077 = false;
            }
         }
         if(!this.var_1077 || param1.type != WindowEvent.const_410)
         {
            return;
         }
         if(this.var_709 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_709) * this.var_709;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_709 != 0)
            {
               _loc3_ = this.var_1076 + this.var_709;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_829 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_829.width,this.var_829.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_829,this.var_829.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_828 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_828.width,this.var_828.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_828,this.var_828.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1967 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_829 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_828 = BitmapData(_loc2_.content);
      }
   }
}
