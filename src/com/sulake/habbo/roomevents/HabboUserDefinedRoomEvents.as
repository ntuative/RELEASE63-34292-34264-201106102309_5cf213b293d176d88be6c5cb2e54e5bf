package com.sulake.habbo.roomevents
{
   ...
   public class HabboUserDefinedRoomEvents extends Component implements IHabboUserDefinedRoomEvents
   {
      ...
      private var var_2012:UserDefinedRoomEventsCtrl;
      ...
      public function HabboUserDefinedRoomEvents(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2012 = new UserDefinedRoomEventsCtrl(this);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            (this._roomEngine as IRoomEngineServices).method_5(this.roomId,this.roomCategory,null);
            return;
         }
         this.var_2012.stuffSelected(param1,param2);
      }
      ...
      {
         return !!this.var_1256 ? int(this.var_1256.roomId) : 0;
      }
      
      public function get roomCategory() : int
      {
         return !!this.var_1256 ? int(this.var_1256.roomCategory) : 0;
      }
