package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2269:String = "my_issues";
      
      private const const_2268:String = "open_issues";
      
      private const const_2270:String = "picked_issues";
      
      private const const_2310:String = "closed_issues";
      ...
      private var var_1731:IIssueBrowserView;
      
      private var var_1733:IIssueBrowserView;
      
      private var var_1732:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_262 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_262.numTabItems)
            {
               _loc5_ = this.var_262.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_262 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_262 == null || this.var_262.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_262.selector.getSelectableByName("open_issues");
         this.var_262.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_359 == _loc2_)
         {
            return;
         }
         if(this.var_359 != null)
         {
            this.var_359.visible = false;
         }
         this.var_359 = _loc2_;
         if(this.var_359 == null)
         {
         ...
         this.var_359.view.width = this.var_262.container.width;
         this.var_359.view.height = this.var_262.container.height;
         this.var_359.visible = true;
         this.var_359.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2269:
               if(this.var_1731 == null)
               {
                  this.var_1731 = new MyIssuesView(this.issueManager,this,this.var_262.container);
               }
               return this.var_1731;
            case this.const_2268:
               if(this.var_1733 == null)
               {
                  this.var_1733 = new OpenIssuesView(this.issueManager,this,this.var_262.container);
               }
               return this.var_1733;
            case this.const_2270:
               if(this.var_1732 == null)
               {
                  this.var_1732 = new PickedIssuesView(this.issueManager,this,this.var_262.container);
               }
