package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1345:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_580 = new UserInfoCtrl(this._window,this.var_75,_loc3_.message);
         this.var_1345 = new UserInfoCtrl(this._window,this.var_75,_loc3_.message);
         ...
         {
            this.var_1345.load(_loc4_,this.var_183.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_75.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_75,WindowTracker.const_1364,_loc2_),this._window,false,false,true);
      }
