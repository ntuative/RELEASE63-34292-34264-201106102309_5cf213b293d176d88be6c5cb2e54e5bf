package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_993:Array = [];
      
      private static var var_1836:int = 200;
      ...
      {
         this.var_793 = IWindowContainer(this.var_37.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_993.pop() as IWindowContainer;
         }
