package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1026:int = 60;
      
      private static const const_1027:int = 3600;
      
      private static const const_1028:int = 86400;
      
      private static const const_1029:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_1026) + " mins ago";
         }
         if(param1 < 2 * const_1028)
         {
            return Math.round(param1 / const_1027) + " hours ago";
         }
         if(param1 < 2 * const_1029)
         {
            return Math.round(param1 / const_1028) + " days ago";
         }
         return Math.round(param1 / const_1029) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_37,WindowTracker.const_1213,this._data.userId),this._callerFrame,this.var_1170,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new RoomVisitsCtrl(this.var_37,this._data.userId),this._callerFrame,this.var_1170,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new SendMsgsCtrl(this.var_37,this._data.userId,this._data.userName,this.var_1493),this._callerFrame,this.var_1170,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.windowTracker.show(new ModActionCtrl(this.var_37,this._data.userId,this._data.userName,this.var_1493),this._callerFrame,this.var_1170,false,true);
      }
