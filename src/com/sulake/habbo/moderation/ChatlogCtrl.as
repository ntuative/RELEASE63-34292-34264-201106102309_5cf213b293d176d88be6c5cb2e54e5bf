package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1045:Array = [];
      
      private static var var_1979:int = 1000;
      
      private static var var_1046:Array = [];
      
      private static var var_1978:int = 200;
      ...
      private var var_1813:IMessageComposer;
      ...
      {
         this.var_834 = IWindowContainer(this.var_37.getXmlWindow("chatlog_roomheader"));
         this.var_835 = IWindowContainer(this.var_37.getXmlWindow("chatlog_chatline"));
         this.var_538 = new Timer(1000,1);
         ...
         this.var_37.connection.send(this.var_1813);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1045.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1046.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1980[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1564.getValue(param2.chatterName))
            {
               this.var_1564.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1564.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1565)
         {
