package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_801:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2564 = param2.pickerUserId;
         this.var_2563 = param2.pickerUserName;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_801 == null || param1.priority > this.var_801.timeStamp)
         {
            this.var_801 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_801;
         if(_loc1_ == null)
         {
