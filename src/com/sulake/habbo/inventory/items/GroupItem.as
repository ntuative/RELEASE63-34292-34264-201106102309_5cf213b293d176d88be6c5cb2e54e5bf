package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2992:BitmapData;
      
      private var var_1527:Boolean;
      
      private const const_2012:Number = 1;
      
      private const const_2011:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2215 == FurniModelCategory.const_37)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1425));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2214);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_994)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2011;
               _loc1_.blend = this.const_2011;
            }
            else
            {
               this._window.blend = this.const_2012;
               _loc1_.blend = this.const_2012;
            }
         }
         this.var_1520.color = !!this.var_1527 ? uint(const_1551) : uint(const_1550);
         this.var_2619.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2213 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2992;
               _loc5_.visible = true;
            }
            else
            {
