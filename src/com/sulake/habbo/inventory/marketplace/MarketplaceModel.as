package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_29 != null && this.var_29.furniModel != null && this.var_234 != null)
         {
            this.var_29.furniModel.removeLockFrom(this.var_234.id);
            this.var_234 = null;
         }
      }
      ...
      {
         if(this.var_234 != null || param1 == null)
         {
            return;
         }
         if(this.var_29 == null)
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_234 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_234.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_234 is FloorItem ? 1 : 2;
         this.var_2238 = _loc2_;
         this.var_2236 = this.var_234.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_234.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_234);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1695,this.var_1694);
         }
      }
      ...
      {
         if(param1 != this.var_2238 || param2 != this.var_2236)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2240);
      }
