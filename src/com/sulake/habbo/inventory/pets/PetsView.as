package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1021:int = 1;
      
      private const const_1053:int = 2;
      
      private const const_1055:int = 3;
      ...
      private var var_232:PetsGridItem;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_232);
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_76.isUnseen(param1.id));
         if(_loc2_ != null)
         {
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_232.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_48)
         {
            ...
            {
               case "tab_floor":
                  this.var_76.switchToFurnitureCategory(FurniModelCategory.const_37);
                  break;
               case "tab_wall":
                  this.var_76.switchToFurnitureCategory(FurniModelCategory.const_44);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_232 != null)
         {
            this.var_232.setSelected(false);
         }
         this.var_232 = param1;
         if(this.var_232 != null)
         {
            this.var_232.setSelected(true);
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_76.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_440) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_76.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_445) > 0;
