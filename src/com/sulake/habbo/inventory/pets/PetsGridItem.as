      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1563.setSelectedGridItem(this);
               this.var_1562 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1562 = false;
                  this.var_1563.placePetToRoom(this._petData.id,true);
               }
         }
      }
