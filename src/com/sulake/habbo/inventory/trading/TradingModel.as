package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1894:uint = 9;
      
      public static const const_200:uint = 0;
      
      public static const const_220:uint = 1;
      
      public static const const_424:uint = 2;
      
      public static const const_372:uint = 3;
      
      public static const const_588:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_58.updateItemList(this.var_770);
         this.var_58.updateItemList(this.var_1472);
      ...
      public function close() : void
      {
         if(this.var_898)
         {
            if(this._state != const_200 && this._state != const_268)
            {
      ...
      {
         this.var_58.setMinimized(param1 != InventoryCategory.const_71);
         this.var_13.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_771 + " OTHER: " + this.var_1189);
         ...
         {
            case const_200:
               if(param1 == const_220 || param1 == const_268)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_269.length)
         {
            _loc2_ = this.var_269.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      {
         if(this._state == const_424)
         {
            this.state = const_372;
         }
      }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_58.alertPopup(TradingView.const_1271);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_770)
            {
               this.var_771 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_269.length < const_1894)
         {
         ...
         else
         {
            ...
            if(this.var_269.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
