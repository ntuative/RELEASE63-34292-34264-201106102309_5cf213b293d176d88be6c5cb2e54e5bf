package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1079:uint = 4284532064;
      
      private static const const_1080:uint = 2577770;
      
      public static const const_1180:int = 0;
      ...
      private var var_664:ItemPopupCtrl;
      ...
      private var var_1028:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_664 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_220)
            {
               this.var_220.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_220.stop();
               this.var_220 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(this.var_78 == null)
         {
            this.var_78 = this.createNormalWindow();
         }
      ...
      {
         return this.var_78.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      
      protected function getOtherUsersItemGrid() : IItemGridWindow
      {
         return this.var_78.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            this.updateActionState();
            _loc2_ = this.var_78.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = this.var_20.otherUserName;
            }
            _loc1_ = this.var_78.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1079) : uint(const_1080);
            }
            _loc3_ = this.var_78.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = this.var_78.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1079) : uint(const_1080);
            }
            _loc3_ = this.var_78.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      public function updateActionState() : void
      {
         ...
         if(this.var_78)
         {
            _loc1_ = this.var_78.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
      ...
      {
         var _loc2_:ITextWindow = this.var_78.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc2_:ITextWindow = this.var_78.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = this.var_78.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      {
         var _loc1_:ITextWindow = this.var_78.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = this.var_78.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_78.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = this.var_78.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      {
         var _loc1_:ITextWindow = this.var_78.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = this.var_78.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_220 = new Timer(1000,3);
            this.var_220.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_220.reset();
         this.var_220.repeatCount = 3;
         this.var_220.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_220.currentCount));
         if(this.var_220.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1028)
         {
            this.var_1028.isSelected = false;
            this.var_1028 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1887)
            {
            ...
            if(_loc5_.category == FurniCategory.const_1191)
            {
               _loc7_ = this.getTraxSongFurniName(_loc4_,_loc7_,true,param2.id,param3);
            }
            this.var_664.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_622);
            this.var_664.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_664.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_193.push(param4);
            this.var_193.push(param1);
            this.var_193.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_193.length > 0)
         {
            _loc2_ = this.var_193.pop();
            _loc3_ = this.var_193.pop();
            _loc4_ = uint(this.var_193.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_664.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_622);
               }
            }
            else
            {
               this.var_193.push(_loc4_);
               this.var_193.push(_loc3_);
