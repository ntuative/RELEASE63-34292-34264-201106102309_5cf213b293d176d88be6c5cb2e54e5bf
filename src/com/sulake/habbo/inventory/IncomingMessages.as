package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         this.var_13 = param1;
         this.var_27 = this.var_13.communication;
         ...
         this.var_27.addHabboConnectionMessageEvent(new UnseenItemsEvent(this.onUnseenItems));
      }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_297);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this.var_13.toggleInventorySubPage(InventorySubCategory.const_368);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_423);
      ...
      {
         var _loc2_:* = null;
         if(this.var_13.isInventoryCategoryInit(InventoryCategory.const_423))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_13.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_440));
         this.var_13.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_445));
         this.var_13.petsModel.addUnseenPets(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_56));
         this.var_13.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1324));
