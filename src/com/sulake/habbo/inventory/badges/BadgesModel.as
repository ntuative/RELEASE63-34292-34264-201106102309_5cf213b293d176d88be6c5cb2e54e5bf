package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2305:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_382 = param5;
         this.var_382.events.addEventListener(BadgeImageReadyEvent.const_117,this.onBadgeImageReady);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1343.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_718.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_382.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_254.unshift(_loc11_);
            }
            else
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_329);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_254.length)
         {
            _loc3_ = this.var_254[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_553);
         ...
         var _loc3_:Array = this.getBadges(const_329);
      ...
      {
         return this.getItemInIndex(param1,const_329);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_553);
      }
      ...
      {
         if(param1 == InventoryCategory.const_297 && this.var_29.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_718.indexOf(_loc2_) == -1)
            {
               this.var_718.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_718 && this.var_718.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1324));
            this.var_718 = [];
