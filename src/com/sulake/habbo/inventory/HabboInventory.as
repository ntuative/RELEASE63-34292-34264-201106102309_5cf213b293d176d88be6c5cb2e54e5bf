package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2287:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_56)
         {
            _loc1_ = this.var_56.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_56.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_78,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_631,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_56.getValue(InventoryCategory.const_71));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_56.getValue(InventorySubCategory.const_368));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_56.getValue(InventoryCategory.EFFECTS));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_56.getValue(InventoryCategory.const_297));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_56.getValue(InventoryCategory.ACHIEVEMENTS));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_56.getValue(InventorySubCategory.const_1151));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_56.getValue(InventoryCategory.const_139));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_56.getValue(InventoryCategory.const_423) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_78,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_631,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_382 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_56.add(InventoryCategory.const_423,_loc1_);
         ...
         this.var_56.add(InventoryCategory.EFFECTS,_loc4_);
         ...
         this.var_56.add(InventoryCategory.ACHIEVEMENTS,_loc5_);
         ...
         this.var_56.add(InventorySubCategory.const_368,_loc6_);
         ...
         this.var_56.add(InventorySubCategory.const_1151,_loc7_);
         ...
         this.var_56.add(InventoryCategory.const_139,_loc8_);
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_56.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_56.length)
         {
            _loc3_ = this.var_56.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_368:
      ...
      public function closingInventoryView() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_56.length)
         {
            _loc2_ = this.var_56.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1059.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1059.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1059.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1059.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc2_:IInventoryModel = this.var_56.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2287);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_263));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2775)
         {
            this.var_2775 = _loc1_;
