package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_2007:int = 0;
      ...
      private static const const_1054:int = 42;
      
      private static const const_1051:int = 120;
      ...
      private var var_876:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_372.add(FurniModelCategory.const_37,new FurniGridView(this.var_76,FurniModelCategory.const_37,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_372.add(FurniModelCategory.const_44,new FurniGridView(this.var_76,FurniModelCategory.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1052;
            _loc3_.y = _loc4_.y + const_1052;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case FurniModelCategory.const_37:
               ...
               this.var_452 = FurniModelCategory.const_37;
               break;
            case FurniModelCategory.const_275:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_452 = FurniModelCategory.const_275;
               break;
            default:
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_372.getValue(this.var_452);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_76.getCategoryContent(this.var_452);
         ...
         if(this.var_2312 == _loc2_)
         {
            return;
         }
         this.var_2312 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_372.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_372.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_372.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_372.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_76.getUnseenItemCount(UnseenItemCategoryEnum.const_440) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_76.getUnseenItemCount(UnseenItemCategoryEnum.const_445) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_76.getGroupItemInIndex(_loc3_,this.var_452);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            if(_loc5_.category == FurniCategory.const_371)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_876 && this.var_876.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1051)
         {
            _loc3_ = const_1051;
         }
         else if(_loc3_ < const_1054)
         {
            _loc3_ = const_1054;
         }
         else
         ...
         else if(param1.type == WindowEvent.const_48)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_275);
            }
         }
      }
