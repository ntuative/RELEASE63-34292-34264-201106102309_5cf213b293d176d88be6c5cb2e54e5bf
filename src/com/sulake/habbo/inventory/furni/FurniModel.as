package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1416:int = 100;
      ...
      private var var_1446:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_435 = [];
         this.var_434 = [];
         this.var_623 = new Timer(const_1416,1);
         this.var_623.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2352 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_152,this.onObjectPlaced);
               }
            ...
            {
               this.var_623.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_623.stop();
               this.var_623 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_37)
            {
               ...
               {
                  this.var_1446 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1446;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_371)
         {
         ...
         if(this.var_761 == null)
         {
            this.var_761 = this._windowManager.buildFromXML(this.var_2352) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_761.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_761.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_71 && this.var_29.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_44:
                  ...
                  break;
               case const_275:
                  this.var_29.toggleInventoryPage(InventoryCategory.const_139);
            }
         }
      }
      ...
      {
         this.var_29.checkCategoryInitilization(InventoryCategory.const_423);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_622.add(const_37,new Array());
         this.var_622.add(const_44,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_37;
            _loc5_ = this.var_435.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_44;
            _loc5_ = this.var_434.indexOf(param1.ref) > -1;
         }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_275)
            {
      ...
      {
         return getTimer() < this.var_2350 + const_1417;
      }
      ...
      {
         return this.var_29.getSubCategoryViewId() == InventorySubCategory.const_368;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_341 || _loc3_.category == FurniCategory.const_371 || _loc3_.category == FurniCategory.const_348)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_622.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_622.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_994)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_435.indexOf(_loc2_) == -1)
            {
               this.var_435.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_434.indexOf(_loc2_) == -1)
            {
               this.var_434.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_440:
               return this.var_435.length;
            case UnseenItemCategoryEnum.const_445:
               return this.var_434.length;
            default:
               return this.var_435.length + this.var_434.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_44:
               if(this.var_434 && this.var_434.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_445));
                  this.var_434 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_37:
               if(this.var_435 && this.var_435.length > 0)
               {
