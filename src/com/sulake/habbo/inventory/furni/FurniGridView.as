   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_76.toggleItemSelection(this._category,this.var_227.getGridItemIndex(param1.window));
            this.var_577 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_577 != null && this.var_577 == param2 && !this.var_76.isTradingOpen)
         {
