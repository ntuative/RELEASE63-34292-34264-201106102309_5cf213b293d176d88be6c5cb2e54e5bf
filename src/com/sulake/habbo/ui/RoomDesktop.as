package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1569:int = 1000;
      ...
      private var var_1266:IRoomWidgetFactory = null;
      
      private var var_382:ISessionDataManager = null;
      
      private var var_16:IRoomSessionManager = null;
      
      private var var_1014:IAvatarRenderManager = null;
      ...
      private var var_1172:IHabboHelp = null;
      ...
      private var var_244:IToolTipWindow;
      
      private var var_2664:uint = 16777215;
      ...
      public function set navigator(param1:IHabboNavigator) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_364,this.onNavigatorEvent);
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_446,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_562,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_820,this.onRoomContentLoaded);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_446,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_562,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_820,this.onRoomContentLoaded);
         }
         ...
         {
            this._navigator.events.removeEventListener(HabboNavigatorEvent.const_364,this.onNavigatorEvent);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_34 != null)
         {
            this.var_824 = this._roomEngine.loadRoomResources(this.var_34.roomResources);
      ...
      {
         if(this.var_341 != null && this.var_34.state == RoomSessionEvent.SESSION_CREATED)
         {
            this.var_1940 = !this.var_341.showInterstitial();
         }
      ...
      {
         if(this.var_824 == null || this.var_824.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_824.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_824.splice(_loc2_,1);
         }
         if(this.var_824.length == 0)
         {
            this.var_1941 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_825.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_825.add(_loc11_,_loc8_);
                  }
                  else
                  {
         ...
         _loc2_ = this.var_1266.createWidget(param1,_loc4_);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_825.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               {
                  _loc2_ = true;
                  if(this.var_382.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_792:
               if(!this.isFurnitureSelectionDisabled(param1))
               {
                  _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_777,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               }
               if(this.var_1088 != null && _loc3_ == RoomObjectCategoryEnum.const_29)
               {
                  _loc7_ = this.var_34.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_130)
                  {
                     this.var_1088.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_176:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_740,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_185:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_430,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_963:
               if(!this.var_34.isRoomController && !this.var_382.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_145:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1216,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_614:
               ...
               break;
            case RoomEngineObjectEvent.const_554:
            ...
            case RoomEngineObjectEvent.const_163:
               ...
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineSoundMachineEvent.const_289:
               this.processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_559:
            ...
            case RoomEngineEvent.const_505:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_451,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_717);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_793);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_931);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_34.roomId,this.var_34.roomCategory,RoomVariableEnum.const_748);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_247,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2664);
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_244 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_244.width / 2,15);
            this.var_244.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1939 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_34.roomId,this.var_34.roomCategory,this.var_329[0],_loc2_.width,_loc2_.height);
         if(this.var_538 == null)
         {
            this.var_538 = new Timer(const_1569,1);
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1939));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1942) / 1000);
      ...
      {
         var _loc2_:* = null;
         if(param1.type == HabboNavigatorEvent.const_364)
         {
            if(this.var_34 != null)
            {
               _loc2_ = this._roomEngine.getRoomCanvasGeometry(this.var_34.roomId,this.var_34.roomCategory,this.getFirstCanvasId());
      ...
      {
         if(this.var_16 != null && this.var_34 != null && this.var_1940 && this.var_1941)
         {
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_554:
               ...
               this.var_244 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_452,WindowStyle.const_137,WindowParam.const_105) as IToolTipWindow;
               this.var_244.setParamFlag(WindowParam.const_31,false);
