package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_694:String = "room_view";
      
      private static const const_1633:String = "room_widget";
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         while(_loc6_ < this.var_96.numChildren)
         {
            ...
            {
               _loc5_.addEventListener(WindowEvent.const_177,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         if(param1 == RoomWidgetEnum.const_359)
         {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1633) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_96.getChildByTag(const_694) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_96.findChildByTag(const_694) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
