package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.WIDGET_MESSAGE_REQUEST_ECOTRONBOX_WIDGET,RoomWidgetEcotronBoxOpenMessage.const_956,RoomWidgetEcotronBoxOpenedMessage.const_1892];
      }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_94,0,this._name,false,param2);
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_334:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_94,0,this._name,false,_loc3_.data);
