package com.sulake.habbo.ui.handler
{
   ...
   public class EffectsWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this._container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_263,this.onEffectsChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         this._container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_263,this.onEffectsChanged);
      }
      ...
      {
         return [RoomWidgetRequestWidgetMessage.const_425];
      }
