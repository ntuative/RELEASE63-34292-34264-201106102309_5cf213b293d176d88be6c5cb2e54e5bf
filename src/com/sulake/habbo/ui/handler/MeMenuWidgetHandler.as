package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this.var_13 && !this.var_13.disposed && this.var_13.events)
            {
               ...
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_999,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_731,this.onHelpTutorialEvent);
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_999,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_731,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1523)
            {
               ...
               this.var_1903 = _loc1_;
               this.var_1904 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1903;
               _loc2_ = this.var_1904;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_466)
               {
                  ...
                  if(_loc2_.height > const_466 - const_1077)
                  {
                     _loc8_.offset(0,_loc2_.height - const_466 + const_1077);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_974);
         _loc1_.push(RoomWidgetDanceMessage.const_741);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_722);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1155);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1204);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1370);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_848);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_450);
         _loc1_.push(RoomWidgetStopEffectMessage.const_715);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1943);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1282);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_527);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1721);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1241);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_933);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_942);
         _loc1_.push(RoomWidgetMeMenuMessage.const_970);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_989);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1975);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_894);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_972);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1148);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_942:
               ...
               break;
            case RoomWidgetWaveMessage.const_974:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_741:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_722:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1155:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1204:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_450:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1302)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_180,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_848:
               ...
               if(this.var_13 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1871:
                        this._catalog.openCatalogPage(CatalogPageName.const_1289,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1290:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1856:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1801:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1370:
            case RoomWidgetStopEffectMessage.const_715:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1282:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_933:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_970:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_527:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_989:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_894:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_435,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_972:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_435,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1148:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_568));
               }
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_731:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_560));
         }
      }
