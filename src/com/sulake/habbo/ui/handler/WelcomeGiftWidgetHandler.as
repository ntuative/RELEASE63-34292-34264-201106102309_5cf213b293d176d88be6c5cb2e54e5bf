package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_751 = [];
         this.var_751.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_751.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_751)
         {
            return;
         }
         for each(_loc1_ in this.var_751)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_857);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_992);
         return _loc1_;
      }
