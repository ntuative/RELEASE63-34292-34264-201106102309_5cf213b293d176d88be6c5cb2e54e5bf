package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_247.events.addEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_247.events.addEventListener(SongInfoReceivedEvent.const_99,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_117,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_194,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_117,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_194,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_712.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_712.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_247 != null)
         {
            this.var_247.events.removeEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_247.events.removeEventListener(SongInfoReceivedEvent.const_99,this.onSongInfoReceivedEvent);
            this.var_247 = null;
         }
         this.var_1123 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_532);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_716);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_846);
         _loc1_.push(RoomWidgetFurniActionMessage.const_251);
         _loc1_.push(RoomWidgetFurniActionMessage.const_753);
         _loc1_.push(RoomWidgetFurniActionMessage.const_881);
         _loc1_.push(RoomWidgetFurniActionMessage.const_948);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1332);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_854);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_770);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_735);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_580);
         _loc1_.push(RoomWidgetPetCommandMessage.const_901);
         _loc1_.push(RoomWidgetUserActionMessage.const_600);
         _loc1_.push(RoomWidgetUserActionMessage.const_415);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_990);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_578)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_415 || param1.type == RoomWidgetUserActionMessage.const_600 || param1.type == RoomWidgetUserActionMessage.const_481)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_532:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_716:
            ...
            case RoomWidgetUserActionMessage.const_621:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1331,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_639:
               ...
               break;
            case RoomWidgetUserActionMessage.const_846:
            ...
            case RoomWidgetUserActionMessage.const_415:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_854:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_770:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_735:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_331);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_433) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_433);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_752) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1362;
               }
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1265);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1252);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_482)
                  {
                     _loc30_ = this.var_247.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_247.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_657)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_327);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_156)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_747);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_824;
                  }
                  if(!_loc35_)
                  {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1816);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_712.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_712.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_747);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_247 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_247.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_247 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_384,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
