package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_2032:IMessageEvent;
      
      private var var_2033:IMessageEvent;
      ...
      {
         this.var_1601 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_2032 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2033 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1601);
         this._connection.addMessageEvent(this.var_2032);
         this._connection.addMessageEvent(this.var_2033);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1601);
               this._connection.removeMessageEvent(this.var_2032);
               this._connection.removeMessageEvent(this.var_2033);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_849,RoomWidgetPlayListModificationMessage.const_761,RoomWidgetPlayListModificationMessage.const_831,RoomWidgetPlayListPlayStateMessage.const_905,RoomWidgetPlayListUserActionMessage.const_918];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_849:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_909,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_761:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_831:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_905:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_289);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_289:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_988,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_993,-1));
            }
         }
      }
