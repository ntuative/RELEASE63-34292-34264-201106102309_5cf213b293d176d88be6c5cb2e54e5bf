package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorItemListView
   {
      ...
      private var var_109:PlayListEditorItem;
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_590);
            }
            return;
         }
         ...
         if(this.var_1215 >= 0 && this.var_1215 < this._items.length)
         {
            _loc2_ = this._items[this.var_1215] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_590);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1287);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_remove_from_playlist" || _loc3_)
            {
               ...
               if(this.var_995 > -1)
               {
                  this._widget.sendRemoveFromPlayListMessage(this.var_995);
               }
               this.var_109 = null;
               this.var_995 = -1;
            }
            else
            {
               ...
               {
                  this.var_995 = _loc4_;
                  this.var_109 = this._items[_loc4_];
                  this.var_109.select();
