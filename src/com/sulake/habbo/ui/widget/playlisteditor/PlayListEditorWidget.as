package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorWidget extends RoomWidgetBase
   {
      ...
      private static const const_1508:int = 130;
      
      private static const const_1506:int = 100;
      
      private static const const_1510:int = 130;
      
      private static const const_1505:int = 100;
      
      private static const const_1509:int = 130;
      
      private static const const_1507:int = 100;
      ...
      {
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_909,this.onShowPlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_988,this.onHidePlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_993,this.onInventoryUpdatedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_790,this.onSongDiskInventoryUpdatedEvent);
      ...
      {
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_909,this.onShowPlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_988,this.onHidePlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_993,this.onInventoryUpdatedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_790,this.onSongDiskInventoryUpdatedEvent);
      ...
      public function getDiskColorTransformFromSongData(param1:String) : ColorTransform
      {
         ...
         _loc2_ = uint(_loc2_ % const_1506 + const_1508);
         _loc3_ = uint(_loc3_ % const_1505 + const_1510);
         _loc4_ = uint(_loc4_ % const_1507 + const_1509);
      ...
      public function sendAddToPlayListMessage(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_761,_loc3_,param1);
      ...
      {
         var _loc2_:RoomWidgetPlayListModificationMessage = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_831,param1);
         if(messageListener != null)
         {
      ...
      public function sendTogglePlayPauseStateMessage() : void
      {
         ...
         var _loc2_:RoomWidgetPlayListPlayStateMessage = new RoomWidgetPlayListPlayStateMessage(RoomWidgetPlayListPlayStateMessage.const_905,this._furniId,_loc1_);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc2_);
         }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this._soundManager.musicController.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_123);
         if(_loc2_ != -1)
         {
         ...
         this._soundManager.musicController.playSong(param1,HabboMusicPrioritiesEnum.const_395,0,0,0,0);
      }
      
      public function stopUserSong() : void
      {
         this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_395);
      }
      ...
      public function openSongDiskShopCataloguePage() : void
      {
         ...
         this._catalog.openCatalogPage(CatalogPageName.const_1749,true);
      }
