package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_925:String = "MISV_BUY_MORE";
      
      public static const const_750:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_1715:ITextWindow;
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1714.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_750,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_925,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_487.add(const_750,_loc1_);
            this.var_1715 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1714 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_586));
         ...
         if(_loc1_ != null)
         {
            this.var_487.add(const_925,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_515));
         }
      }
