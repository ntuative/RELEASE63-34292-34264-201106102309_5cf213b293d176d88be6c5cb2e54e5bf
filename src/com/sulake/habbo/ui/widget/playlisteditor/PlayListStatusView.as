package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_807:String = "PLSV_ADD_SONGS";
      
      public static const const_1135:String = "PLSV_START_PLAYBACK";
      
      public static const const_503:String = "PLSV_NOW_PLAYING";
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_487[const_807];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_487.add(const_503,_loc1_);
