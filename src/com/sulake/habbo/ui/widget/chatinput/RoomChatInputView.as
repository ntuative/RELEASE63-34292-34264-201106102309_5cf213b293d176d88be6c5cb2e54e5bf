package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1568:String = "${widgets.chatinput.say}";
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1264 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2661 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2660 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_386 = new Timer(1000,1);
         this.var_386.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_464 = new Timer(10000,1);
         this.var_464.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_464.reset();
            this.var_464.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_464 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1936 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1937 = this._window.findChildByName("send_button_text");
         this.var_1548 = this._window.findChildByName("block_text");
         this.var_1937.caption = const_1568;
         ...
         this.var_28.addEventListener(WindowKeyboardEvent.const_214,this.windowKeyEventProcessor);
         this.var_28.addEventListener(WindowKeyboardEvent.const_352,this.keyUpHandler);
         this.var_28.addEventListener(WindowEvent.const_111,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_9);
         this.var_1546 = true;
         this.var_673 = "";
         this._window.addEventListener(WindowEvent.const_775,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_635,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1936.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1567 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1566);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_28 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1264 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_28.text = "";
                  this.var_673 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_673.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_674);
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_131);
