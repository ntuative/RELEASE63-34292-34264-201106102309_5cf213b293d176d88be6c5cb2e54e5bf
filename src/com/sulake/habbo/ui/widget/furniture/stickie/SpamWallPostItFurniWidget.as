package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2210 = "spamwall_postit_container";
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_520,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_520,this.onEditPostItRequest);
      }
      ...
      {
         hideInterface(false);
         var_231 = param1.objectId;
         this.var_491 = param1.location;
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_231 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_919,var_231,this.var_491,_text,var_349);
