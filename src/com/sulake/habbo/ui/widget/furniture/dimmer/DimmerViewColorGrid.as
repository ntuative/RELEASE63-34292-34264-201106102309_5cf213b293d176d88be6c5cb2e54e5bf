package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_1777:XML;
      
      private var var_632:BitmapData;
      
      private var var_1180:BitmapData;
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_523.numGridItems)
         {
            return;
         }
         this.select(this.var_523.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_523 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         this.var_523.destroyGridItems();
         this.var_232 = null;
         for each(_loc2_ in this.colors)
         {
            _loc3_ = param1.buildFromXML(this.var_1777) as IWindowContainer;
            ...
            this.var_523.addGridItem(_loc3_);
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1180.width,this.var_1180.height,true,0);
      ...
      {
         var _loc2_:int = this.var_523.getGridItemIndex(param1.target as IWindow);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1777 = XML(_loc2_.content);
         ...
         this.var_1180 = BitmapData(_loc3_.content);
