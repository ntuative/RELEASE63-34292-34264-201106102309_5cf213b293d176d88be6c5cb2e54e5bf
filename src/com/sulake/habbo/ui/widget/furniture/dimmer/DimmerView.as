package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_75,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1402,const_1403,2,2),null,0) as IWindowContainer;
         ...
         this.var_262 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_262.numTabItems)
         {
            _loc6_ = this.var_262.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1430 = _loc2_.light;
         if(this.var_431 != null)
         {
            this.var_431.setValue(this.var_1430);
         }
         this.var_582 = this.colors.indexOf(_loc2_.color);
         if(this.var_612 != null)
         {
            this.var_612.setSelectedColorIndex(this.var_582);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_262.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_262.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_262.selector.getSelected();
         return this.var_262.selector.getSelectableIndex(_loc1_);
      }
      
      private function get windowXML() : XML
      {
         if(this.var_1431 != null)
         {
         ...
         this.var_1431 = XML(_loc1_.content);
         return this.var_1431;
      }
