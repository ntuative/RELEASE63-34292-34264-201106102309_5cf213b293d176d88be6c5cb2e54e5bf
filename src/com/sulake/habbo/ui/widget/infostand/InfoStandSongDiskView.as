package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_384 && param1.songId == this.var_1798)
         {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         if(var_48 != null)
         {
            var_54 = var_48.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         ...
         var_260 = var_48.findChildByTag("catalog");
         if(var_260 != null)
         {
            var_260.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
