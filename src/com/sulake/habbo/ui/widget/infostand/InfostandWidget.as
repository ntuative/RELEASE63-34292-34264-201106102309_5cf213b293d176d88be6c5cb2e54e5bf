package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_2040:String = "infostand_user_view";
      
      private const const_2036:String = "infostand_furni_view";
      
      private const const_2038:String = "infostand_pet_view";
      
      private const const_2039:String = "infostand_bot_view";
      
      private const const_2037:String = "infostand_jukebox_view";
      
      private const const_2041:String = "infostand_songdisk_view";
      
      private var var_1359:InfoStandFurniView;
      ...
      private var var_1107:InfoStandJukeboxView;
      
      private var var_1108:InfoStandSongDiskView;
      
      private var var_2956:Array;
      
      private var var_1656:InfostandUserData;
      
      private var var_622:InfostandFurniData;
      ...
      private const const_2308:int = 3000;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1359 = new InfoStandFurniView(this,this.const_2036,this._catalog);
         this.var_205 = new InfoStandUserView(this,this.const_2040);
         this.var_417 = new InfoStandPetView(this,this.const_2038,this._catalog);
         this.var_494 = new InfoStandBotView(this,this.const_2039);
         this.var_1107 = new InfoStandJukeboxView(this,this.const_2037,this._catalog);
         this.var_1108 = new InfoStandSongDiskView(this,this.const_2041,this._catalog);
         this.var_1656 = new InfostandUserData();
         this.var_622 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_184 = new Timer(this.const_2308);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_75,HabboWindowStyle.const_46,HabboWindowParam.const_46,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_777,this.onRoomObjectSelected);
         ...
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_156,this.onUserInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_967,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_777,this.onRoomObjectSelected);
         ...
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_156,this.onUserInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_967,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_415,this.var_417.getCurrentPetId()));
      }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_482)
         {
         ...
         {
            this.var_1108.update(param1);
            this.selectView(this.const_2041);
         }
         else
         {
            this.var_1359.update(param1);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_205.setTags(param1.tags,this.var_2956);
         }
      }
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(this.userData.isBot())
            {
               this.var_494.method_7(_loc2_,param1.badgeImage);
            }
            else
            {
               this.var_205.method_7(_loc2_,param1.badgeImage);
            }
            return;
         }
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_532,param1.id,param1.category);
      ...
      {
         this.var_1107.updateSongInfo(param1);
         this.var_1108.updateSongInfo(param1);
      }
