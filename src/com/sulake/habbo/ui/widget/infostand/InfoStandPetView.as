package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1432:int = 152;
      
      private static const const_1429:int = 16;
      
      private static const const_671:int = 4;
      
      private static const const_1435:uint = 14342874;
      
      private static const const_1434:uint = 3815994;
      
      private static const const_1437:uint = 2085362;
      
      private static const const_1441:uint = 39616;
      
      private static const const_1440:uint = 10513106;
      
      private static const const_1439:uint = 8734654;
      
      private static const const_1438:uint = 9094430;
      
      private static const const_1436:uint = 6200576;
      
      private static const const_1431:String = "happiness";
      
      private static const const_1428:String = "experience";
      
      private static const const_1433:String = "energy";
      
      private static const const_1430:int = 250;
      
      private static const const_1030:int = 25;
      
      private static const const_1031:int = 5;
      ...
      {
         if(this.var_54 == null || this.var_48 == null || this.var_106 == null)
         {
            return;
         }
         ...
         this.var_48.height = this.var_54.height + 20;
         this._window.width = Math.max(this.var_48.width,this.var_106.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_48.width < this.var_106.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1431,param1.nutrition,param1.nutritionMax,const_1441,const_1437);
         this.updateStateElement(const_1428,param1.experience,param1.experienceMax,const_1439,const_1440);
         this.updateStateElement(const_1433,param1.energy,param1.energyMax,const_1436,const_1438);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1432,const_1429,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1435);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1434);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this.var_48 != null)
         {
            this.var_54 = this.var_48.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_212 && this.var_212.getPetId() == this.var_559)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1919,true);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1030 + const_1031;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1031;
            }
         }
         this.var_106.height = _loc4_ + const_1030;
         this.updateWindow();
      }
   }
}
