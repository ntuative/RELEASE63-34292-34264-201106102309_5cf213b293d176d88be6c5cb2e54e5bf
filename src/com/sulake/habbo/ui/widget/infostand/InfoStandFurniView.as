package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_260 = this.var_48.findChildByTag("catalog");
         if(this.var_260 != null)
         {
            this.var_260.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               break;
            case "HabboNavigatorCom_rico_top2_png":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_54 == null || this.var_48 == null || this._buttons == null)
         {
            return;
         }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1362 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_482 && param1.isRoomOwner)
         {
         ...
         this.showButton("HabboNavigatorCom_rico_top2_png",_loc6_);
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1278.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_54.addListItem(this.var_260);
            }
            this.var_260.visible = param1;
         }
         else
         {
            this.var_54.removeListItem(this.var_260);
         }
      }
   }
}
