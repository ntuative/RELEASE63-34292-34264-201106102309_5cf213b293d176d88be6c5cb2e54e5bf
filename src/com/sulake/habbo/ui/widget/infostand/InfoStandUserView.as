package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_2567:Boolean = true;
      
      private const const_1062:int = 5;
      
      private const const_2278:int = 3;
      
      private const const_1504:int = 11184810;
      
      private const const_1503:int = 16777215;
      
      private const const_2280:int = 2000;
      
      private const const_2277:int = 50;
      
      private const const_2279:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_2567 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1062;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc5_.textColor = this.const_1503;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1062,this.const_2277);
         _loc5_.height = Math.max(_loc5_.height,this.const_2279);
         _loc3_.height = _loc5_.height + this.const_2278;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_352,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_352,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2566 > this.const_2280 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2566 = _loc6_;
               _loc3_.textColor = this.const_1503;
            }
         }
         else
         {
