package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_465:IFrameWindow;
      ...
      private const const_2283:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_387 = new Timer(this.const_2283);
         this.var_387.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1265.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1265.getValue(this.var_559) as CommandConfiguration;
      ...
      {
         this.var_1265.remove(param1);
         this.var_1265.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_901,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_44.setParamFlag(WindowParam.const_105,true);
         ...
         this.var_44.position = const_1450;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_465 == null)
         {
            ...
            this.var_465 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_465 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_465.x = 200;
            this.var_465.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_415,this.var_559));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_580,this.var_559,this.var_1938 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_580,this.var_559,this.var_1938 + " " + _loc5_);
