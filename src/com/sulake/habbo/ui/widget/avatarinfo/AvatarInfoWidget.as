package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1121:String = "use_minimized_own_avatar_menu";
      ...
      private var var_255:AvatarInfoData;
      ...
      private var var_890:AvatarInfoView;
      
      private var var_892:OwnAvatarMenuView;
      
      private var var_891:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_23 = param6;
         this.var_191 = param4;
         this.var_255 = new AvatarInfoData();
         this.var_2934 = Boolean(this.var_191.getBoolean("menu.avatar.enabled",false));
         this.var_2124 = this.var_191.getBoolean("menu.own_avatar.enabled",false);
         ...
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_263,this.onEffectsChanged);
         this.handler.widget = this;
      }
      
      public function get handler() : AvatarInfoWidgetHandler
      {
         return var_1119 as AvatarInfoWidgetHandler;
      }
      ...
      private function onRoomObjectRemoved(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.category == RoomObjectCategoryEnum.const_29)
         {
            for each(_loc2_ in this.var_413)
            {
      ...
      override public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_413)
         {
            _loc1_.dispose();
         }
         this.var_413 = null;
         ...
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_263,this.onEffectsChanged);
         this._view = null;
         this.var_191 = null;
         super.dispose();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_156,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_141,this.updateEventHandler);
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_331,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_451,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_539,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_740,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_430,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_156,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_141,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_331,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_451,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_539,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_430,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_430,this.updateEventHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_129:
               ...
               if(this.var_2124 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_539:
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_331:
               if(this._view)
               {
                  this.removeView(this._view,false);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_740:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_2123 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_716,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_430:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_2123)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_156:
               _loc3_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.storeUserInfo(_loc3_);
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_130,false,!!_loc3_.isSpectatorMode ? null : this.var_255);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_657,false,null);
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_189:
               ...
               for each(_loc7_ in this.var_413)
               {
            ...
            case RoomWidgetRoomEngineUpdateEvent.const_96:
               this.var_1949 = false;
               break;
            case RoomWidgetRoomEngineUpdateEvent.const_451:
               this.var_1949 = true;
         }
      ...
      private function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_332,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      {
         this.var_255.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_255.amIController = param1.amIController;
         this.var_255.amIOwner = param1.amIOwner;
         this.var_255.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_255.canBeKicked = param1.canBeKicked;
         this.var_255.canTrade = param1.canTrade;
         this.var_255.canTradeReason = param1.canTradeReason;
         this.var_255.hasFlatControl = param1.hasFlatControl;
         this.var_255.isIgnored = param1.isIgnored;
         this.var_255.respectLeft = param1.respectLeft;
         this.var_255.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_110;
         this.var_255.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_2124) : Boolean(this.var_2934);
         }
            ...
            if(!this.var_1949)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_892)
                     {
                        this.var_892 = new OwnAvatarMenuView(this);
                     }
                     this._view = this.var_892;
                  ...
                  else
                  {
                     if(!this.var_891)
                     {
                        this.var_891 = new AvatarMenuView(this);
                     }
                     this._view = this.var_891;
                     AvatarMenuView.setup(this._view as AvatarMenuView,param1,param2,param3,param4,param6);
                     for each(_loc8_ in this.var_413)
                     {
               ...
               else
               {
                  if(!this.var_890)
                  {
                     this.var_890 = new AvatarInfoView(this);
                  }
                  this._view = this.var_890;
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_413.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_413.length > 0)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         for each(_loc3_ in this.var_413)
         {
      ...
      {
         return this.handler.container.config.getBoolean(const_1121,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1121,!!param1 ? "1" : "0");
      }
   }
}
