package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_154,this.showPollOffer);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_77,this.showPollError);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_171,this.showPollContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_154,this.showPollOffer);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_77,this.showPollError);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_171,this.showPollContent);
      }
