package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_165["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_165["dance_icon"] = ["dance_white","dance_color"];
         this.var_165["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_165["effects_icon"] = ["effects_white","effects_color"];
         this.var_165["badges_icon"] = ["badges_white","badges_color"];
         this.var_165["wave_icon"] = ["wave_white","wave_color"];
         this.var_165["hc_icon"] = ["_white","_color"];
         this.var_165["settings_icon"] = ["settings_white","settings_color"];
         this.var_165["credits_icon"] = ["credits_white","credits_color"];
         this.var_165["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            this.var_165[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_165[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_165)
         {
            _loc6_ = this.var_165[_loc3_];
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1360);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1250));
            ...
            case "effects":
               ...
               this._widget.messageListener.processWidgetMessage(new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_425));
               this._widget.hide();
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1290));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_527));
               this._widget.hide();
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1302));
               this._widget.hide();
               break;
            case "settings":
            ...
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","false") == "UserTypingMessageEvent";
               if(false && _loc4_)
               {
