package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_944 = param1.volume;
         if(this.var_945 != null)
         {
            this.var_945.setValue(this.var_944);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_943 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_989));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_944 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_940);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_942);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_943);
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_894);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_972);
         }
