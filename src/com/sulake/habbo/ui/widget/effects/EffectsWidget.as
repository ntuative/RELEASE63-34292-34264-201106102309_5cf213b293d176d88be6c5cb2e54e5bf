package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectsWidget extends RoomWidgetBase
   {
      ...
      private static const const_1614:int = 320;
      
      private static const const_1615:int = 48;
      
      private static const const_1613:int = 2;
      ...
      {
         return var_1119 as EffectsWidgetHandler;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_698)
         {
            for each(_loc1_ in this.var_698)
            {
               _loc1_.dispose();
            }
      ...
      public function open() : void
      {
         ...
         if(!this._view)
         {
            ...
            this._view.x = _loc2_.right + const_1613;
      ...
      public function update() : void
      {
         ...
         {
            _loc1_ = this.var_698.getValue(_loc3_.type) as EffectView;
            if(_loc1_)
            {
               _loc1_.update();
            }
            else
            {
               ...
               this.var_698.add(_loc3_.type,_loc1_);
         ...
         _loc4_ = this.var_64.scrollableRegion.height;
         this.var_64.height = Math.max(Math.min(_loc4_,const_1614),const_1615);
      ...
      {
         this.handler.container.catalog.openCatalogPage(CatalogPageName.const_1289,true);
      }
   }
}
