package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2273:int = 1000;
      
      private var _widget:EffectsWidget;
      
      private var _window:IWindowContainer;
      
      private var var_124:IWidgetAvatarEffect;
      
      private var var_640:IWindow;
      
      private var var_320:Number;
      
      private var var_529:ITextWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_124 = param2;
         this._widget = param1;
         this.var_220 = new Timer(this.const_2273);
         this.var_220.addEventListener(TimerEvent.TIMER,this.onUpdate);
         this.update();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_220.stop();
            this.var_220.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_220 = null;
         }
         this._widget = null;
         this.var_124 = null;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_124.isActive)
         {
            _loc2_ = this.var_124.secondsLeft / Number(this.var_124.duration);
            this.var_640.width = _loc2_ * this.var_320;
         }
         else
         {
            this.var_640.width = 0;
            this.var_220.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_529 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_529 == null)
            {
               return;
            }
         ...
         if(!this.var_124.isActive)
         {
            this.var_529.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_529.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_529.text;
         var _loc2_:int = this.var_124.secondsLeft;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_75,HabboWindowStyle.const_30,HabboWindowParam.const_64) as IWindowContainer;
         }
         ...
         this.var_529 = null;
         var _loc2_:String = "";
         if(this.var_124.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_124.isActive)
         {
         ...
         else
         {
            ...
            this.var_639 = this._window.findChildByName("effect_hilite");
            this.var_639.visible = false;
         }
         this.setTimeLeft();
         this.var_640 = this._window.findChildByName("loader_bar");
         if(this.var_640 != null)
         {
            this.var_320 = this.var_640.width;
            this.var_220.start();
            this.onUpdate();
         }
         if(this.var_124.icon)
         {
            this.setElementBitmap("effect_icon",this.var_124.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_124.type,this.var_124.isInUse);
         }
      }
