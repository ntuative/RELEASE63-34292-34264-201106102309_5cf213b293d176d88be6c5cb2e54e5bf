package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1765:String = "normal_badge";
       
      
      private const const_2001:String = "badge_";
      ...
      private function getBadgeImageInternal(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc3_:String = this.const_2001 + param1;
         ...
         switch(param2)
         {
            case const_1765:
               ...
               {
                  _loc5_ = this.var_191.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1239:
               if(this.var_191 != null)
               {
                  if(this.var_191 != null)
                  {
                     _loc5_ = this.var_191.getKey("group.badge.url");
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_2001,"");
