package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1103:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1627:String = "sendAccessTokenToServer";
      
      private static const const_1628:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1627,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1628,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1103);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1103);
         }
      }
