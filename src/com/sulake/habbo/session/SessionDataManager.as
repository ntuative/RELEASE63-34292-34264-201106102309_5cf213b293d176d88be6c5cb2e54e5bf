package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1196:HabboGroupInfoManager;
      ...
      private var var_1198:FaceBookSession;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1196 = new HabboGroupInfoManager(this,events);
         this.var_983 = new IgnoredUsersManager(this);
         this.var_1198 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_317)
         {
            this.var_317.removeEventListener(FurnitureDataParser.const_122,this.onFurnitureReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1200 = new BadgeImageManager(context.root.assets,events,this.var_191,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1196.communication = this._communication;
         this.var_1198.communication = this._communication;
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_317)
         {
            ...
            this.var_317 = new FurnitureDataParser(this.var_530,this._wallItems,this.var_531,this._localization);
            this.var_317.addEventListener(FurnitureDataParser.const_122,this.onFurnitureReady);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_1814 = _loc2_.clubLevel;
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_1056));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2434 = _loc2_.isOpen;
         this.var_2435 = _loc2_.onShutDown;
      }
      ...
      {
         return this._securityLevel >= SecurityLevelEnum.const_1224;
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         var _loc2_:HabboGroupDetails = this.var_1196.getGroupDetails(param1);
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_1196.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1196.getBadgeId(param1);
      }
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_773 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_773 = this.var_773 - 1;
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_531.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_641 == null)
         {
            ...
            this.var_641 = new ProductDataParser(_loc2_,this.var_1138);
