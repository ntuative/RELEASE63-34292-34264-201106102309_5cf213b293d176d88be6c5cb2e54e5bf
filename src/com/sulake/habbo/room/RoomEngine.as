package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_691:String = "temporary_room";
      
      private static const const_378:int = -1;
      
      private static const const_690:String = "room";
      
      private static const const_1089:int = -2;
      
      private static const const_1581:String = "tile_cursor";
      
      private static const const_1090:int = -3;
      
      private static const const_1582:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_379:String = "object_icon_sprite";
      
      private static const const_468:int = 15;
      
      private static const const_1091:int = 40;
      ...
      private var var_837:IRoomObjectFactory = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_837.release(new IIDRoomObjectFactory());
            this.var_837 = null;
         }
         if(this.var_566 != null)
         {
            this.var_566.release(new IIDRoomObjectVisualizationFactory());
            this.var_566 = null;
         }
         ...
         if(this.var_288 != null)
         {
            ...
            {
               _loc2_ = this.var_288.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         if(this.var_288 != null)
         {
            _loc4_ = this.var_288.getValue(_loc3_) as RoomInstanceData;
            if(_loc4_ == null)
            {
               _loc4_ = new RoomInstanceData(param1,param2);
               this.var_288.add(_loc3_,_loc4_);
            }
         }
         return _loc4_;
      }
      ...
      public function method_5(param1:int, param2:int, param3:SelectedRoomObjectData) : void
      {
         var _loc4_:RoomInstanceData = this.getRoomInstanceData(param1,param2);
         if(_loc4_ != null)
         {
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:IRoomSession = this.var_16.getSession(this.var_91,this.var_90);
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_1049 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_288.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_91 || _loc6_ != this.var_90 || !this.var_1048)
                  {
               ...
               if(_loc11_ != null)
               {
                  if(this.var_1048)
                  {
                     _loc11_.screenOffsetX += this.var_1567;
                     _loc11_.screenOffsetY += this.var_1570;
                     this.var_1567 = 0;
                     this.var_1570 = 0;
                  }
               }
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_717) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_931) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_793) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.const_748) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_837 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_566 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_14 != null)
         {
            this.var_14.visualizationFactory = this.var_566;
         }
         this.initializeRoomManager();
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_472 != null)
            {
               this.var_472.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_14 != null)
         {
            events.addEventListener(RoomContentLoader.const_951,this.onContentLoaderReady);
            this.var_14.initialize(events,this.var_150);
         }
         this.var_2719 = this.var_150.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_951)
         {
            this.var_2718 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_341.events.addEventListener(AdEvent.const_485,this.showRoomAd);
         this.var_341.events.addEventListener(AdEvent.const_902,this.onRoomAdImageLoaded);
         this.var_341.events.addEventListener(AdEvent.const_1300,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_14.sessionDataManager = this.var_382;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_78,this.onRoomSessionEvent);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_78:
               if(this.var_472)
               {
                  this.var_472.setCurrentRoom(param1.session.roomId,param1.session.roomCategory);
               }
               break;
            case RoomSessionEvent.const_85:
               if(this.var_472)
               {
                  this.var_472.resetCurrentRoom();
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_837 != null)
         {
            this.var_837.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_837 == null || this.var_566 == null || this._roomManager == null || this._roomRendererFactory == null || this._communication == null || this.var_150 == null || !this.var_2718)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_563 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_719,0,0));
            _loc2_ = 0;
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1251,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_559,param1,param2));
            }
            else
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1251);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_175,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_378,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1351,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_755,1,true);
            _loc12_ = parseInt(this.var_150.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1358,_loc12_,true);
            if(this.var_14 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_378,const_690,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_755,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_754,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_717,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_793,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_931,_loc17_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1275,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_915,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_222,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_766,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               ...
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_488,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_299);
                        ...
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              ...
                              _loc7_.setNumber(RoomObjectVariableEnum.const_968,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_721,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_968,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1214,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1238,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_1089,const_1581,RoomObjectCategoryEnum.const_318);
         if(this.var_150.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1090,const_1582,RoomObjectCategoryEnum.const_318);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_378,RoomObjectCategoryEnum.const_86);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(param3 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_915,param3);
         ...
         if(param4 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_766,param4);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         if(param5 != null)
         {
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1722,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1330,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1137,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectRoomPlaneThicknesses(param1:int, param2:int, param3:Number, param4:Number) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1255,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_672,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_288.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_361,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1347;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_754);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_721);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_968);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1214);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1238);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1568;
         ...
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1048 = true;
               this.var_836 = false;
               this.var_2717 = this.var_1568;
               this.var_2716 = this.var_1571;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1048)
            {
               if(!this.var_836)
               {
                  _loc8_ = param2 - this.var_2717;
                  _loc9_ = param3 - this.var_2716;
                  if(_loc8_ <= -const_468 || _loc8_ >= const_468 || _loc9_ <= -const_468 || _loc9_ >= const_468)
                  {
                     this.var_836 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_379);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_525,this.var_91,this.var_90,-1,RoomObjectCategoryEnum.const_158));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_73 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_378,const_690);
                     this.var_73.handleRoomObjectEvent(_loc14_,this.var_91,this.var_90);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_91,this.var_90,this.var_1569);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_379);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_379,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1568 - _loc5_.data.width / 2;
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_91,this.var_90,this.var_1569);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_379);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_91,this.var_90,this.var_1569);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_379);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            return this.var_73.modifyRoomObject(this.var_91,this.var_90,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_73.modifyRoomObjectData(this.var_91,this.var_90,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            ...
            {
               return this.var_73.modifyWallItemData(this.var_91,this.var_90,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_73.deleteWallItem(this.var_91,this.var_90,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_755) != 0)
         {
            return false;
         }
         if(this.var_73 != null)
         {
            return this.var_73.initializeRoomObjectInsert(this.var_91,this.var_90,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_73 != null)
         {
            this.var_73.cancelRoomObjectInsert(this.var_91,this.var_90);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1090,RoomObjectCategoryEnum.const_318);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1089,RoomObjectCategoryEnum.const_318);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_294,_loc7_,true);
            ...
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_749,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1265,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1252,getTimer());
            if(param4.knownAsUsable)
            {
               _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_752,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_184,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function changeObjectState(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         {
            _loc6_ = Number(_loc5_.getModelController().getNumber(RoomObjectVariableEnum.const_815));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
            ...
            _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_815,_loc6_);
         }
      }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_294,_loc6_,false);
            ...
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1347,1,true);
            if(param4.knownAsUsable)
            {
               _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_752,1);
            }
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1162) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1258);
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_184,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      public function updateObjectUserAction(param1:int, param2:int, param3:int, param4:String, param5:int, param6:String = null) : Boolean
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectVariableEnum.const_270:
               ...
               break;
            case RoomObjectVariableEnum.const_508:
               _loc8_ = new RoomObjectAvatarTypingUpdateMessage(param5 != 0);
               break;
            case RoomObjectVariableEnum.const_327:
            ...
            case RoomObjectVariableEnum.const_443:
               ...
               break;
            case RoomObjectVariableEnum.const_434:
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            if(_loc4_.disposeObject(param2,param3))
            {
               if(events != null)
               {
                  events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_436,this.var_91,this.var_90,param2,param3));
               }
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_73 != null)
         {
            this.var_73.handleRoomObjectEvent(param1,this.var_91,this.var_90);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_294));
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               if(_loc7_ != null)
               {
                  _loc13_ = null;
                  _loc14_ = "undefined_1";
                  _loc13_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_488,_loc14_,_loc7_,new Vector3d(2.5,0.5,2));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_691);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_691,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_838.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_27:
            case RoomObjectCategoryEnum.const_26:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_294,int(param2));
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_907,int(param2));
               }
               break;
         ...
         if(!this.isRoomObjectContentAvailable(param1) && param5 != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1138,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_838.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_91,this.var_90,const_378,RoomObjectCategoryEnum.const_86,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_691);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1138);
               ...
               this.var_838.freeNumber(_loc10_ - 1);
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ != null && _loc6_.getModel() != null && _loc6_.getEventHandler() != null)
         {
            ...
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_923,_loc4_,_loc5_,param2,param3));
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_442,param1.image,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1359,param1.adWarningL,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1305,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1295,RoomObjectVariableEnum.const_442,param1.clickUrl);
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_902:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1355,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_1300:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1329,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
