   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2932 = param1.extra;
            this.var_1344 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1344 > 0 && param1 >= this.var_1344)
         {
            this.var_1344 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_2121,String(this.var_2121),this.var_2932);
