package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1496:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_537,RoomObjectMouseEvent.const_143];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1303,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_736,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_869,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1001,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_802,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1226)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1857;
            if(_loc2_ - this.var_1226 >= this.var_1854)
            {
               _loc3_ = this.var_1225;
               _loc4_ = this.var_1856;
               this.var_1226 = 0;
            }
            else
            {
               _loc7_ = this.var_1496 >> 16 & 255;
               _loc8_ = this.var_1496 >> 8 & 255;
               _loc9_ = this.var_1496 & 255;
               _loc10_ = this.var_1225 >> 16 & 255;
               _loc11_ = this.var_1225 >> 8 & 255;
               _loc12_ = this.var_1225 & 255;
               _loc13_ = (_loc2_ - this.var_1226) / this.var_1854;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1855 + (this.var_1856 - this.var_1855) * _loc13_;
               this._color = _loc3_;
               this.var_1857 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_736,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_915:
               param2.setString(RoomObjectVariableEnum.const_222,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_766:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_488:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_299)
               {
                  _loc5_ = "null";
               }
               this.var_574.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_734:
               _loc4_ = this.var_574.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_574.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1137:
               param2.setNumber(RoomObjectVariableEnum.const_869,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1330:
               param2.setNumber(RoomObjectVariableEnum.const_1001,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_802,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_672:
               param2.setNumber(RoomObjectVariableEnum.const_1352,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1255:
               param2.setNumber(RoomObjectVariableEnum.const_1219,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1279,int(param1.bgOnly));
         this.var_1496 = this._color;
         this.var_1855 = this.var_1857;
         this.var_1225 = _loc3_;
         this.var_1856 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_605,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1777,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1815,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1716,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_605,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_285 || _loc12_ == RoomPlaneData.const_397)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
