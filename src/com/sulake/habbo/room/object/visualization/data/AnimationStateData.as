   ...
   public class AnimationStateData
   {
      ...
      public function resetAnimationFrames(param1:Boolean = true) : void
      {
         ...
         while(_loc2_ < this.var_695)
         {
            ...
            this.var_1063[_loc2_] = false;
            this.var_1064[_loc2_] = false;
            _loc2_++;
         }
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_695)
         {
