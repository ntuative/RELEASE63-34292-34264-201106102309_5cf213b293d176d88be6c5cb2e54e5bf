package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_869 = param1.@defaultPosture;
         }
         else
         {
            this.var_869 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_704.add(_loc6_,_loc7_);
         ...
         if(this.var_704.getValue(this.var_869) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_870.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      public function getAnimationForPosture(param1:String) : int
      {
         ...
         return int(this.var_704.getValue(param1));
      }
      
      public function getAnimationForGesture(param1:String) : int
      {
         if(this.var_870.getValue(param1) == null)
         {
            return const_837;
         }
         return int(this.var_870.getValue(param1));
      }
      
      public function getPostureForAnimation(param1:int) : String
      {
         if(param1 >= 0 && param1 < this.var_704.length)
         {
            return this.var_704.getKey(param1);
         }
         return this.var_869;
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_870.length)
         {
            return this.var_870.getKey(param1);
         }
         return null;
      }
      ...
      {
         return this.var_704.length;
      }
      
      public function getGestureCount() : int
      {
         return this.var_870.length;
      }
   }
}
