package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class ExperienceData
   {
      ...
      {
         if(this.var_2911 == param1 || this.var_95 == null)
         {
            return;
         }
         this.var_95.copyPixels(this._copy,this._copy.rect,new Point(0,0));
         ...
         this.var_95.draw(_loc3_,_loc4_);
      }
   }
}
