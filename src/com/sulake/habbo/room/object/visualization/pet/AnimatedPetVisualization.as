package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1653:String = "head";
      
      private static const const_701:int = 1;
      
      private static const const_1123:int = 1000;
      
      private static const const_1652:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1652) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_258);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_160);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_258);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1742 = _loc3_.getNumber(RoomObjectVariableEnum.const_270) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_205);
            if(!isNaN(_loc8_))
            {
               this.var_2135 = _loc8_;
            }
            else
            {
               this.var_2135 = direction;
            }
            this.var_1654 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2521 = _loc3_.getNumber(RoomObjectVariableEnum.const_443);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_907);
            if(_loc9_ != this.var_2134)
            {
               this.var_2134 = _loc9_;
               this.var_2950 = this.var_2134.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_416 != null)
         {
            ...
            if(this.var_1654 > 0)
            {
               _loc2_ = param1 - this.var_1654;
               if(_loc2_ < const_1123)
               {
                  this.var_416.alpha = int(Math.sin(_loc2_ / const_1123 * 0) * 255);
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_263)
         {
            this.var_263 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_101,param1);
            this.setAnimationForIndex(const_1654,_loc3_);
         }
         if(param2 != this.var_1434)
         {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2950);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_701)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_561.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_561[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2135);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_101,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1653)
            {
               this.var_1106[param1] = true;
            }
            else
            {
               this.var_1106[param1] = false;
            }
         }
         return this.var_1106[param1];
      }
   }
}
