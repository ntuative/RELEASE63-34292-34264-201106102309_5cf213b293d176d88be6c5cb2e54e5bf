package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2077:int = 1;
      
      public static const const_2160:int = 16777216;
      ...
      private var var_2049:int = 16777216;
      
      private var var_3028:int = 69069;
      
      private var var_3029:int = 5;
      ...
      {
         var _loc1_:int = this.var_3028 * this.var_2048 + this.var_3029;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2049;
         this.var_2048 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2049 * param2);
      }
   }
}
