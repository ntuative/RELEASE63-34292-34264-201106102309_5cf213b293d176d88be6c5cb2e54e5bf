package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_552:WallRasterizer;
      
      private var var_553:FloorRasterizer;
      
      private var var_812:WallAdRasterizer;
      
      private var var_551:LandscapeRasterizer;
      
      private var var_811:PlaneMaskManager;
      ...
      {
         super();
         this.var_552 = new WallRasterizer();
         this.var_553 = new FloorRasterizer();
         this.var_812 = new WallAdRasterizer();
         this.var_551 = new LandscapeRasterizer();
         this.var_811 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc7_ = _loc2_[0];
            this.var_552.initialize(_loc7_);
         }
         ...
         {
            _loc9_ = _loc4_[0];
            this.var_812.initialize(_loc9_);
         }
         ...
         {
            _loc11_ = _loc6_[0];
            this.var_811.initialize(_loc11_);
         }
         return true;
      }
      ...
      public function initializeAssetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         this.var_812.initializeAssetCollection(param1);
         this.var_551.initializeAssetCollection(param1);
         this.var_811.initializeAssetCollection(param1);
         this.var_769 = true;
      }
