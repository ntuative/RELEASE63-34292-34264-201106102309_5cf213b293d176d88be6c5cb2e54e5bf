package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1757:int = 0;
      ...
      private var var_1330:Vector3d = null;
      ...
      private var var_2855:Number = 0;
      
      private var _color:uint = 0;
      
      private var var_1091:IPlaneRasterizer = null;
      
      private var var_811:PlaneMaskManager = null;
      ...
      private var var_2917:Number = 0;
      
      private var var_2914:Number = 0;
      
      private var var_224:Map = null;
      
      private var var_488:PlaneBitmapData = null;
      ...
      private var var_885:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1637 = [];
         super();
         this.var_2913 = param8;
         this.var_1330 = new Vector3d();
         this.var_1330.assign(param1);
         ...
         this._normal = Vector3d.crossProduct(this.var_338,this.var_337);
         ...
         this.var_2916 = param10;
         this.var_2917 = param11;
         this.var_2914 = param12;
         this.var_1093 = param6;
      }
      ...
      {
         return this._isVisible && this.var_885;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1091.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_488;
         if(_loc3_ == null)
         {
         ...
         if(this.var_885 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_411))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_338.length * param1.scale;
            ...
            if(this.var_1091 != null)
            {
               _loc3_ = this.var_1091.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2102,this.var_2915,this.var_2916,this.var_2917,this.var_2914,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1840 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_885)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1614.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1614[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1330);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_177.z - originZ,this.var_133.z - originZ,this.var_97.z - originZ,this.var_132.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2855 = relativeDepth;
            this._isVisible = true;
            this.var_1840 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2913);
      ...
      {
         this.var_177.assign(param1.getScreenPosition(this.var_105));
         this.var_133.assign(param1.getScreenPosition(Vector3d.sum(this.var_105,this.var_337)));
         this.var_97.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_105,this.var_338),this.var_337)));
         this.var_132.assign(param1.getScreenPosition(Vector3d.sum(this.var_105,this.var_338)));
         this._offset = param1.getScreenPoint(this.var_1330);
         ...
         var _loc2_:Number = Math.min(this.var_177.x,this.var_133.x,this.var_97.x,this.var_132.x);
         var _loc3_:Number = Math.max(this.var_177.x,this.var_133.x,this.var_97.x,this.var_132.x);
         var _loc4_:Number = Math.min(this.var_177.y,this.var_133.y,this.var_97.y,this.var_132.y);
         var _loc5_:Number = Math.max(this.var_177.y,this.var_133.y,this.var_97.y,this.var_132.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_177 == null || this.var_133 == null || this.var_97 == null || this.var_132 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_132.x - this.var_97.x;
         var _loc4_:Number = this.var_132.y - this.var_97.y;
         var _loc5_:Number = this.var_133.x - this.var_97.x;
         var _loc6_:Number = this.var_133.y - this.var_97.y;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1093)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_412.length)
            {
               _loc5_ = this.var_412[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_299.length == this.var_1092.length)
         {
            while(_loc1_ < this.var_299.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_1092[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_412.length > this.var_1637.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1093 || this.var_299.length == 0 && this.var_412.length == 0 && !this.var_411 || this.var_811 == null)
         {
            return;
         }
         ...
         if(this.var_411)
         {
            ...
            while(_loc5_ < this.var_299.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc3_.leftSideLoc / this.var_338.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc3_.rightSideLoc / this.var_337.length;
                  _loc12_ = _loc3_.type;
                  this.var_811.updateMask(this.var_79,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1092.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_412.length)
            {
               _loc4_ = this.var_412[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc4_.leftSideLoc / this.var_338.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc4_.rightSideLoc / this.var_337.length;
                  _loc13_ = this.var_79.width * _loc4_.leftSideLength / this.var_338.length;
                  _loc14_ = this.var_79.height * _loc4_.rightSideLength / this.var_337.length;
                  this.var_79.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1637.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_411 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_253.copyChannel(param1,param1.rect,const_699,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_253.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_253,this.var_253.rect,const_699,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
