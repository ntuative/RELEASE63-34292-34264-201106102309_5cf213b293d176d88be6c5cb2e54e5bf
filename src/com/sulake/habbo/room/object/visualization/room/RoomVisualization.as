package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1885:int = 16777215;
      ...
      public static const const_1902:int = 16777215;
      
      public static const const_1731:int = 13421772;
      
      public static const const_1734:int = 10066329;
      ...
      private var var_877:Rectangle = null;
      
      private var var_574:RoomPlaneBitmapMaskParser = null;
      
      private var var_1467:String = null;
      
      private var _floorType:String = null;
      
      private var var_1468:String = null;
      
      private var _floorThicknessMultiplier:Number = NaN;
      
      private var var_1457:Number = NaN;
      
      private var var_2067:String = null;
      
      private var var_1328:uint = 16777215;
      
      private var var_2851:int = 255;
      
      private var var_2852:int = 255;
      
      private var var_2854:int = 255;
      
      private var var_2068:Boolean = true;
      
      private var var_1329:int = 0;
      
      private var var_1954:int = -1000;
      
      private const const_2290:int = 250;
      
      private var var_1840:int = -1;
      
      private var var_1616:Number = 0.0;
      
      private var var_2850:Number = 0.0;
      
      private var var_2853:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_574 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_877 = super.boundingRectangle;
         }
         return new Rectangle(this.var_877.x,this.var_877.y,this.var_877.width,this.var_877.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1457))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1457;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1303);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1275);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_397)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1902;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1731;
               }
               else
               {
                  _loc13_.color = const_1734;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1708)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_69,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_397)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1954 + this.const_2290 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_406.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2068)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2854 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2852 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2851 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1840)
         {
            this.var_1840 = param1.updateId;
            this.var_877 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1616 || _loc3_.y != this.var_2850 || _loc3_.z != this.var_2853 || param1.scale != this.var_2066))
            {
               this.var_1616 = _loc3_.x;
               this.var_2850 = _loc3_.y;
               this.var_2853 = _loc3_.z;
               this.var_2066 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_164 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_2067)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2067 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_736));
            if(_loc4_ != this.var_1328)
            {
               this.var_1328 = _loc4_;
               this.var_2854 = this.var_1328 & 255;
               this.var_2852 = this.var_1328 >> 8 & 255;
               this.var_2851 = this.var_1328 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1279));
            if(_loc5_ != this.var_2068)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_164 != param1.getUpdateID())
         {
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_869));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1001));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_802));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_164 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1352);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1219);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1457))
            {
               this._floorThicknessMultiplier = _loc2_;
               this.var_1457 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1329;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_574.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_574.maskCount)
         {
            _loc10_ = this.var_574.getMaskType(_loc8_);
            _loc11_ = this.var_574.getMaskLocation(_loc8_);
            _loc12_ = this.var_574.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_69 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_299)
                              {
