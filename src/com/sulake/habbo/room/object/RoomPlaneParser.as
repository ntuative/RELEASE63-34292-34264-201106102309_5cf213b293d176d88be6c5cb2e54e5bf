package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_672:Number = 0.25;
      
      private static const const_1255:Number = 0.25;
      ...
      private var var_1457:Number = 1.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_630.push(_loc5_);
            _loc3_++;
         }
         this.var_283 = param1;
         this._height = param2;
         this.var_443 = this.var_283;
         this.var_441 = -1;
         this.var_440 = this._height;
         this.var_442 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_283 && param2 >= 0 && param2 < this._height)
         {
            ...
            if(param3 >= 0)
            {
               ...
               if(param2 < this.var_440)
               {
                  this.var_440 = param2;
               }
               if(param2 > this.var_442)
               {
                  this.var_442 = param2;
               }
            }
            ...
            {
               if(param1 == this.var_443 || param1 == this.var_441)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_440;
                  while(_loc6_ < this.var_442)
                  {
               ...
               if(param2 == this.var_440 || param2 == this.var_442)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_443;
                  while(_loc8_ < this.var_441)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < this.var_283)
            {
               this.var_630[_loc2_][_loc8_] = this.var_123[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         ...
         this.var_1100 = getFloorHeight(this.var_123);
         if(!param1)
         {
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_285,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_397,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1255 * this.var_1457;
         var _loc9_:Number = const_672 * this._floorThicknessMultiplier;
         ...
         this.addPlane(RoomPlaneData.const_285,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_285,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_285,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_285,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_246,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_672 * this._floorThicknessMultiplier;
            _loc19_ = _loc18_;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_246,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_246,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_246,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_246,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_283}" height="{this._height}" wallHeight="{this.var_1456}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc5_ = <tileRow/>;
            _loc6_ = this.var_630[_loc2_];
            _loc7_ = 0;
            while(_loc7_ < this.var_283)
            {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1230;
         }
         var _loc2_:RoomPlaneData = this.var_155[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
