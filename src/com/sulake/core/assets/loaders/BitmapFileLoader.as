package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1129 = new LoaderContext();
         this.var_1129.checkPolicyFile = true;
         ...
         {
            this.var_45.load(param2,this.var_1129);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_352 = 0;
         this.var_45.load(param1,this.var_1129);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_352 < var_3002)
            {
               ...
               this.var_45.load(new URLRequest(this.var_1126 + (this.var_1126.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_352),this.var_1129);
               return true;
            }
         }
         return false;
