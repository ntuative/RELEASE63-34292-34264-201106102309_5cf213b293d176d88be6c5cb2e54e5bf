package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_601:uint = 0;
      ...
      private var var_1713:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_571 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_119 is BitmapDataAsset)
         {
            ...
            this.var_1612 = BitmapDataAsset(this.var_119).var_1612;
            this.var_1611 = BitmapDataAsset(this.var_119).var_1611;
            if(this._bitmap != null)
            {
               this.var_119 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1612 = _loc4_ == "1" || _loc4_ == "UserTypingMessageEvent";
                  break;
               case "flipV":
                  this.var_1611 = _loc4_ == "1" || _loc4_ == "UserTypingMessageEvent";
                  break;
            }
            _loc2_++;
         }
