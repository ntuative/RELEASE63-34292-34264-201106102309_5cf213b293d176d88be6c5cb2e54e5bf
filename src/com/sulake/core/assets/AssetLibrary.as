package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1342:String = "AssetLibraryReady";
      
      public static const const_983:String = "AssetLibraryLoaded";
      
      public static const const_1956:String = "AssetLibraryUnloaded";
      
      public static const const_1879:String = "AssetLibraryLoadError";
      ...
      private static var var_323:Dictionary;
      
      private static var var_1859:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_453 = 0;
         this.var_455 = new Array();
         if(var_323 == null)
         {
            var_323 = new Dictionary(false);
         ...
         ++var_544;
         this.var_454 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_653 + " doesn\'t contain valid resource class!");
         }
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_653 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_653 == param1.url && this.var_1004)
         {
            ...
            dispatchEvent(new Event(AssetLibrary.const_1342));
         }
         else
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1199,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1340,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1291,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_453;
                     this.var_455.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_455.length ? this.getAssetByName(this.var_455[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_171)
         {
            ...
            {
               return this.var_455.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_171[param1] != null || (this.var_652 != null ? this.var_652[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               ++this.var_453;
               this.var_455.push(param1);
            }
            this.var_171[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_1859.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_171)
            {
               if(this.var_171[_loc2_] == param1)
               {
                  this.var_455.splice(this.var_455.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_323.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_323[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_454.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_454[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_323[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_454[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_323)
            {
               _loc3_ = AssetTypeDeclaration(var_323[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_454)
         {
            _loc3_ = AssetTypeDeclaration(this.var_454[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_323)
            {
               _loc4_ = AssetTypeDeclaration(var_323[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_454)
         {
            _loc4_ = AssetTypeDeclaration(this.var_454[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_653 = _loc2_.url;
         if(this.var_1006)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_652);
         }
         this.var_1004 = true;
         dispatchEvent(new Event(AssetLibrary.const_983));
         dispatchEvent(new Event(AssetLibrary.const_1342));
         if(this.var_1006)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1879));
         this.var_45 = null;
      }
            ...
            if(_loc2_ != null)
            {
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_679) && _loc3_.attribute(const_679).toString() == param1)
                  {
                     ...
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_653 + "!");
                     }
