package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      private var var_1135:IEncryption;
      
      private var var_739:IProtocol;
      
      private var _id:String;
      
      private var var_1136:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1136 = new MessageClassManager();
         this.var_81 = new Socket();
         this.var_209 = new Timer(const_1769,1);
      ...
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_297.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_297.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1136.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         var _loc6_:ByteArray = this.var_739.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_509)
         {
            this.var_509.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1135 != null)
         {
            _loc3_ = this.var_1135.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1136.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_739.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_739.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1135 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_739.getMessages(this.var_508,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1136.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_297.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_297.getMessageParser(parserClass);
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_508.writeByte(this.var_81.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_209.stop();
         this.var_1690 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_740));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1690 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_740));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_740));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_740));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_740));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_740));
