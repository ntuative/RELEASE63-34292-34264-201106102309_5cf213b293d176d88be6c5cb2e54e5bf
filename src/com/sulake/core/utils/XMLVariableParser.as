package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1918:String = "float";
      
      public static const const_35:String = "Boolean";
      
      public static const const_1796:String = "bool";
      ...
      private static const const_2035:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_295 || _loc5_ == const_172)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1918:
               return Number(param1);
            case const_35:
               return param1 == const_683 || int(param1) > 0;
            case const_1796:
               return param1 == const_683 || int(param1) > 0;
            case const_169:
               return uint(param1);
