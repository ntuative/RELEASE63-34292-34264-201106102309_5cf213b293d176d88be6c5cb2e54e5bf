package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_422:Rectangle;
      
      protected var var_68:Rectangle;
      
      protected var var_160:Rectangle;
      ...
      protected var var_258:uint = 16777215;
      
      protected var var_592:uint;
      
      protected var var_497:uint = 10;
      
      protected var var_727:Boolean = true;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_87 = param4;
         this.var_910 = param8 == null ? new Array() : param8;
         this._context = param6;
         this.var_11 = param7.clone();
         this.var_422 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this._context = null;
            this._state = WindowState.const_476;
            this.var_910 = null;
         }
      }
      ...
      {
         return this.var_422.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_422.height;
      }
      ...
      {
         return this.var_160.width;
      }
      
      public function getMinimizedHeight() : int
      {
         return this.var_160.height;
      }
