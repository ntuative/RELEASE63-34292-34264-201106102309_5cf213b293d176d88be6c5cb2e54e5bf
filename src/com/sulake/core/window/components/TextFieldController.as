package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1672:uint = 500;
      
      protected var var_1391:String = "";
      
      protected var var_1389:Boolean = false;
      
      protected var var_769:Boolean = false;
      ...
      {
         this.var_1391 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_769 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_214,event,this,null);
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_352,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_781,false,PropertyStruct.const_35,true) : PropertyDefaults.const_1862);
         _loc1_.push(this.var_1389 != PropertyDefaults.const_1264 ? new PropertyStruct(PropertyDefaults.const_921,this.var_1389,PropertyStruct.const_35,true) : PropertyDefaults.const_1962);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1160 ? new PropertyStruct(PropertyDefaults.const_973,_field.selectable,PropertyStruct.const_35,true) : PropertyDefaults.const_1974);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1301 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_35,true) : PropertyDefaults.const_1865);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_921:
               ...
               case PropertyDefaults.const_781:
                  ...
                  break;
               case PropertyDefaults.const_1197:
