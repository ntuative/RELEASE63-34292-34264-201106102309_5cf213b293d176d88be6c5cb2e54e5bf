package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_637)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_637)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_920,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1884);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1257)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_788,param1.toolTipDelay,PropertyStruct.const_280,true));
         }
         else
         {
      ...
      {
         this.var_1391 = param1 == null ? "null" : param1;
      }
