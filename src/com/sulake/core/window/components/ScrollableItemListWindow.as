package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1238:IItemListWindow;
      
      private var var_456:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_456)
         {
            this.var_456.removeEventListener(WindowEvent.const_264,this.scrollBarEventProc);
            this.var_456.removeEventListener(WindowEvent.const_267,this.scrollBarEventProc);
            this.var_456 = null;
         }
         if(this.var_1238)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1238)
         {
            this.var_1238 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_456)
         {
            this.var_456 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_456)
            {
               this.var_456.addEventListener(WindowEvent.const_264,this.scrollBarEventProc);
               this.var_456.addEventListener(WindowEvent.const_267,this.scrollBarEventProc);
            }
         }
         return this.var_456;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_267)
         {
            this.hideScrollBar();
         }
      }
