package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_285.lenght - 1)
         {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_195 == null || this.var_195.disposed)
         {
            this.var_195 = context.create(name + "::submenu","",WindowType.const_632,var_87,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_285.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_1036 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_1036)
         {
            if(this.open())
            {
               if(this.var_285.length)
               {
                  this.populateMenuItemContainer(this.var_285,this.getSubMenu(),this.subMenuEventProc);
                  this.var_1036 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1036 = false;
            this.getTitleLabel().text = this.var_671 < this.var_285.length && this.var_671 > -1 ? this.var_285[this.var_671] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_565,var_87,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_388,var_87,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_671 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_671).setStateFlag(WindowState.const_58,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_1002)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1222:
            case WindowMouseEvent.const_57:
               ...
               break;
            case WindowTouchEvent.const_813:
      ...
      public function open() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1720,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_285[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_285.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_865,this.var_285,PropertyStruct.const_172,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1980);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_865)
            {
