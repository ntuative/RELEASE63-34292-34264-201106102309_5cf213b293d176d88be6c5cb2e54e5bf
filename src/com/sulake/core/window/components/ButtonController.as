package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1374:Number = 0.5;
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_264:
                  try
                  {
                     getChildByName(const_456).blend = getChildByName(const_456).blend + const_1374;
                  }
                  catch(e:Error)
                  {
                  }
                  break;
               case WindowEvent.const_267:
                  try
                  {
                     getChildByName(const_456).blend = getChildByName(const_456).blend - const_1374;
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1222:
                  type = "null";
                  break;
               case WindowTouchEvent.const_1002:
                  type = "null";
            }
