package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2016:String = "_POINTER_UP";
      
      private static const const_2017:String = "_POINTER_DOWN";
      
      private static const const_2019:String = "_POINTER_LEFT";
      
      private static const const_2018:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_724,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
