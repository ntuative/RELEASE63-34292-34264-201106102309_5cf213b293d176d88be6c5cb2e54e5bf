package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1375:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_914:Number;
      ...
      protected var var_139:Boolean = false;
      
      protected var var_1122:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_460,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_460 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_460,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_226);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_829 ? true : null;
         }
      ...
      {
         this.var_914 = param1;
         this._field.scrollH = this.var_914 * Number(this._field.maxScrollH);
         this.refreshTextImage();
      }
      
      public function set scrollV(param1:Number) : void
      {
         if(param1 > this.var_594)
         {
            this.var_594 = param1;
            this._field.scrollV = Math.max(this._field.scrollV,param1 * this._field.maxScrollV + 1);
            this.refreshTextImage();
         }
         else if(param1 < this.var_594)
         {
            this.var_594 = param1;
      ...
      {
         return new Rectangle(this.var_914 * this.maxScrollH,this.var_594 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_828,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1242));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1283 ? new PropertyStruct(PropertyDefaults.const_982,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1163) : PropertyDefaults.const_1866);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_280,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1218 ? new PropertyStruct(PropertyDefaults.const_1231,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1136) : PropertyDefaults.const_1860);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_995) ? new PropertyStruct(PropertyDefaults.const_411,this._field.textColor,PropertyStruct.const_169,true) : PropertyDefaults.const_1297);
         _loc1_.push(this.var_460 != TextStyleManager.const_226 ? new PropertyStruct(PropertyDefaults.const_417,this.var_460,PropertyStruct.const_51,true,PropertyDefaults.const_898) : PropertyDefaults.const_1253);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_808 ? new PropertyStruct(PropertyDefaults.const_276,this.var_42.left,PropertyStruct.const_39,true) : PropertyDefaults.const_858);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_936 ? new PropertyStruct(PropertyDefaults.const_286,this.var_42.top,PropertyStruct.const_39,true) : PropertyDefaults.const_805);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_733 ? new PropertyStruct(PropertyDefaults.const_260,this.var_42.right,PropertyStruct.const_39,true) : PropertyDefaults.const_959);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_821 ? new PropertyStruct(PropertyDefaults.const_308,this.var_42.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_817);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1159 ? new PropertyStruct(PropertyDefaults.const_886,this._field.mouseWheelEnabled,PropertyStruct.const_35,true) : PropertyDefaults.const_1953);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_121,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_121,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_121,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
