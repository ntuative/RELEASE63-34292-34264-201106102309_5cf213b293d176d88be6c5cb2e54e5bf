package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_364:Object = null;
      
      private var var_460:String = "regular";
      
      private var _text:String = "";
      
      private var var_139:Boolean = false;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_364);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2388 = _loc2_.textWidth;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_364 != _loc2_.color : this.var_364 != null && this.var_364 != PropertyDefaults.const_995) ? new PropertyStruct(PropertyDefaults.const_411,this.var_364,PropertyStruct.const_169,true) : PropertyDefaults.const_1297);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_808)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_276,this.var_42.left,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_858);
            }
            if(this.var_42.top != PropertyDefaults.const_936)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_286,this.var_42.top,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_805);
            }
            if(this.var_42.right != PropertyDefaults.const_733)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,this.var_42.right,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_959);
            }
            if(this.var_42.bottom != PropertyDefaults.const_821)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_308,this.var_42.bottom,PropertyStruct.const_39,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_411:
                  this.var_364 = _loc2_.value as uint;
                  break;
