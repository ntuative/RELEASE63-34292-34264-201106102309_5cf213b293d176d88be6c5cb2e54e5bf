package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1547:String = "_TITLE";
      
      private static const const_1545:String = "_HEADER";
      
      private static const const_1544:String = "_CONTENT";
      
      private static const const_1546:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1525:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1547) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1525 = findChildByTag(const_1545) as IHeaderWindow;
            if(!this.var_1525)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_196 = findChildByTag(const_1544) as IWindowContainer;
            if(!this.var_196)
            {
      ...
      {
         return findChildByTag(const_1546) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1381,_loc2_,false);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_276,_loc3_.left,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_286,_loc3_.top,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,0 - _loc3_.right,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_308,0 - _loc3_.bottom,PropertyStruct.const_39,_loc2_));
         return _loc1_;
      }
