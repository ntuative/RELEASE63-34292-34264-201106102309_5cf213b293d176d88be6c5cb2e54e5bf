package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1572:String = "increment";
      
      private static const const_1571:String = "decrement";
      
      private static const const_1087:String = "slider_track";
      
      private static const const_689:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_731:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_186 = false;
         this.var_19 = param12;
         this._horizontal = param2 == WindowType.const_615;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_506,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_506,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1038 != null)
         {
            _loc2_ = this.var_1038;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1038 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1087) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_689) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_689:
               if(param2.type == WindowEvent.const_231)
               {
                  if(!this.var_1267)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_635)
         {
            if(this.var_19 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_319)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_731;
                  }
                  else
                  {
                     this.scrollV -= this.var_731;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_1002)
         {
            ...
            else if(param2.name == const_1571)
            {
               if(this.var_19)
               {
                  this.var_1267 = true;
            ...
            else if(param2.name == const_1087)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_689).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1038) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1038) as IScrollableWindow;
               if(_loc1_)
               {
