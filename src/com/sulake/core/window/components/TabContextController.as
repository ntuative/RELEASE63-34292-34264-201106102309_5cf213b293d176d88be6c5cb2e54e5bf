package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1649:String = "_SELECTOR";
      
      private static const const_1650:String = "_CONTENT";
       
      
      protected var var_1133:ITabSelectorWindow;
      
      protected var var_2227:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1133 = findChildByTag(const_1649) as ITabSelectorWindow;
            if(this.var_1133 != null)
            {
               this.var_1133.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2227 = findChildByTag(const_1650) as IWindowContainer;
         }
      ...
      {
         return !!this.var_769 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1133.numSelectables;
      }
