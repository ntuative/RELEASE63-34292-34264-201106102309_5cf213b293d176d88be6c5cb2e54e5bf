package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static var var_426:Point = new Point();
       
      
      protected var var_738:Point;
      
      protected var var_187:WindowController;
      ...
      protected var var_918:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_355 = new Array();
            var_355[0] = MouseCursorType.const_369;
            var_355[1] = MouseCursorType.const_30;
            var_355[2] = MouseCursorType.const_369;
            var_355[3] = MouseCursorType.const_369;
            var_355[4] = MouseCursorType.const_369;
            var_355[5] = MouseCursorType.const_30;
            var_355[6] = MouseCursorType.const_369;
         }
         if(var_308 == null)
         {
            var_308 = new Array();
            var_308[0] = WindowState.const_87;
            var_308[1] = WindowState.const_89;
            var_308[2] = WindowState.const_90;
            var_308[3] = WindowState.const_73;
            var_308[4] = WindowState.const_58;
            var_308[5] = WindowState.const_98;
            var_308[6] = WindowState.const_88;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_247;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_93 = state.desktop;
         this.var_71 = state.var_1382 as WindowController;
         this.var_187 = state.var_1386 as WindowController;
         this.var_173 = state.renderer;
         this.var_918 = state.var_1384;
         eventQueue.begin();
         this.var_738.x = -1;
         this.var_738.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_738.x || event.stageY != this.var_738.y)
            {
               ...
               array = new Array();
               this.var_93.groupParameterFilteredChildrenUnderPoint(this.var_738,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               ...
               {
                  if(this.var_71 != this.var_93 && !this.var_71.disposed)
                  {
                     this.var_71.getGlobalPosition(var_426);
                     ...
                     this.var_71 = WindowController(this.var_93);
                     tempWindowEvent.recycle();
                  }
               }
               else if(event.type == MouseEvent.MOUSE_DOWN)
               {
                  window = this.var_93.getActiveWindow();
                  if(window)
                  {
                     window.deactivate();
                  }
               ...
               if(child != null && child.visible)
               {
                  if(event.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(child != this.var_71)
                     {
                        ...
                        if(!child.disposed)
                        {
                           child.getGlobalPosition(var_426);
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_918.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.desktop = this.var_93;
         state.var_1382 = this.var_71;
         state.var_1386 = this.var_187;
         state.renderer = this.var_173;
         state.var_1384 = this.var_918;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param2.type == MouseEvent.MOUSE_UP)
         {
            ...
            {
               if(this.var_187 && !this.var_187.disposed)
               {
                  this.var_187.update(this.var_187,convertMouseEventType(new MouseEvent(MouseEvent.MOUSE_UP,false,true,param2.localX,param2.localY,null,param2.ctrlKey,param2.altKey,param2.shiftKey,param2.buttonDown,param2.delta),this.var_187,param1));
                  this.var_187 = null;
                  if(param1.disposed)
                  {
                     return null;
         ...
         if(param1.testParamFlag(WindowParam.const_604))
         {
