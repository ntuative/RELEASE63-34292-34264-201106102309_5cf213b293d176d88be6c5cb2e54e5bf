package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1228:String = "_EXCLUDE";
      
      public static const const_2177:String = "_INCLUDE";
      
      public static const const_2069:String = "_TEMP";
      
      private static const const_1520:String = "layout";
      
      private static const const_1063:String = "window";
      
      private static const const_1064:String = "variables";
      
      private static const const_1065:String = "filters";
      
      private static const const_679:String = "name";
      
      private static const const_1524:String = "style";
      
      private static const const_684:String = "params";
      
      private static const const_1521:String = "tags";
      ...
      private static const const_1522:String = "visible";
      
      private static const const_1526:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1179:String = "blend";
      
      private static const const_1523:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1515:String = "treshold";
      
      private static const const_1516:String = "children";
      
      private static const const_1525:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1518:String = "height_min";
      
      private static const const_1517:String = "height_max";
      
      private static const const_683:String = "UserTypingMessageEvent";
      
      private static const const_196:String = "0";
      
      private static const const_1519:String = "$";
      
      private static const const_1514:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1513:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1527:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1395:Dictionary;
      
      protected var var_1396:Dictionary;
      
      protected var var_1121:Dictionary;
      
      protected var var_1674:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1395,this.var_1396);
         this.var_1121 = new Dictionary();
         this.var_1674 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1121,this.var_1674);
         this.var_2212 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1527,const_50);
         return param1.replace(const_1513,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1395)
            {
               delete this.var_1395[_loc1_];
            }
            for(_loc1_ in this.var_1396)
            {
               delete this.var_1396[_loc1_];
            }
            for(_loc1_ in this.var_1121)
            {
               delete this.var_1121[_loc1_];
            }
            for(_loc1_ in this.var_1674)
            {
               delete this.var_1674[_loc1_];
            }
            this.var_2212.dispose();
            this.var_2212 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1520)
         {
            _loc8_ = param1.child(const_1064);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1065).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1395[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_679,variables,"")));
         style = uint(this.parseAttribute(xml,const_1524,variables,style));
         params = uint(this.parseAttribute(xml,const_684,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1521,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_196));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_196));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_196));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_196));
         visible = this.parseAttribute(xml,const_1522,variables,visible.toString()) == const_683;
         ...
         if(xml.child(const_684).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_679,variables,"") as String;
               if(this.var_1121[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_679)) + "\"!");
               }
               params |= this.var_1121[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1526,variables,caption)));
         if(tag != const_50)
         {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1064)[0]),tags) as WindowController;
         ...
         window.limits.minHeight = int(this.parseAttribute(xml,const_1518,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1517,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_683;
         blend = Number(this.parseAttribute(xml,const_1179,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1523,variables,window.clipping.toString()) == const_683;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1515,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1065).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_215)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1396[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1228) == -1)
                  {
