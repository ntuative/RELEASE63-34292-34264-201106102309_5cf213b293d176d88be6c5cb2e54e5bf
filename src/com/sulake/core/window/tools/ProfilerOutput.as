package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1603:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1602:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_175:IProfiler;
      
      private var var_26:ICore;
      
      private var _window:IFrameWindow;
      
      private var var_3027:Array;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3027 = new Array();
         this.var_175 = this.profiler;
         this._windowManager = param2;
         this.var_1112 = param3;
         var _loc4_:ByteArray = new var_1603() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_175)
         {
            this.var_175.removeStopEventListener(this.refresh);
            this.var_175 = null;
         }
         if(!this.var_175 && param1)
         {
            this.var_175 = param1;
            this.var_175.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_484)
            {
               this.var_2034 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_175.getProfilerAgentsInArray();
         ...
         if(this.var_2034)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_175.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_175.numBitmapAssetInstances + " / " + this.var_175.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_1112.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_175.numTrackedBitmapDataInstances + " / " + this.var_175.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1602() as ByteArray;
