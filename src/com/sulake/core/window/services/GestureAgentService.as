   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_220 = new Timer(40,0);
            this.var_220.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_220.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1387 *= 0.75;
         this.var_1388 *= 0.75;
         if(Math.abs(this.var_1387) <= 1 && Math.abs(this.var_1388) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_307 != null)
         {
            this.var_307(this.var_1387,this.var_1388);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_220.stop();
            this.var_220.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_220 = null;
         }
         if(this._working)
         {
