package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_728:Point;
      
      protected var var_1499:uint;
      ...
      public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         ...
         {
            this.var_162.addEventListener(MouseEvent.MOUSE_DOWN,this.handler,false);
            this.var_162.addEventListener(MouseEvent.MOUSE_UP,this.handler,false);
            this.var_162.addEventListener(Event.ENTER_FRAME,this.handler);
            this._mouse.x = this.var_162.mouseX;
            this._mouse.y = this.var_162.mouseY;
            this._window = WindowController(param1);
            this.getMousePositionRelativeTo(param1,this._mouse,this._offset);
            this._window.addEventListener(WindowEvent.const_316,this.clientWindowDestroyed);
            this._working = true;
         }
         return _loc3_;
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         if(this._working)
         {
            ...
            {
               this.var_162.removeEventListener(MouseEvent.MOUSE_DOWN,this.handler,false);
               this.var_162.removeEventListener(MouseEvent.MOUSE_UP,this.handler,false);
               this.var_162.removeEventListener(Event.ENTER_FRAME,this.handler);
               if(!this._window.disposed)
               {
                  this._window.removeEventListener(WindowEvent.const_316,this.clientWindowDestroyed);
               }
               this._window = null;
               this._working = false;
            }
      ...
      protected function handler(param1:Event) : void
      {
         ...
         if(this._working)
         {
            if(param1.type == Event.ENTER_FRAME)
            {
               ...
               else if(this._mouse.x != this.var_162.mouseX || this._mouse.y != this.var_162.mouseY)
               {
                  this.operate(this.var_162.mouseX,this.var_162.mouseY);
                  this._mouse.x = this.var_162.mouseX;
                  this._mouse.y = this.var_162.mouseY;
               }
               return;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_728);
         this._window.offset(this.var_728.x - this._offset.x,this.var_728.y - this._offset.y);
      }
