package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_100:String = "UserData";
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "UserTypingMessageEvent";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "UserTypingMessageEvent";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_346 = SkinLayoutEntity.const_483;
                  break;
               case "move":
                  _loc5_.var_346 = SkinLayoutEntity.const_349;
                  break;
               case "strech":
                  _loc5_.var_346 = SkinLayoutEntity.const_550;
                  break;
               case "tiled":
                  _loc5_.var_346 = SkinLayoutEntity.const_314;
                  break;
               case "center":
                  _loc5_.var_346 = SkinLayoutEntity.const_487;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_348 = SkinLayoutEntity.const_483;
                  break;
               case "move":
                  _loc5_.var_348 = SkinLayoutEntity.const_349;
                  break;
               case "strech":
                  _loc5_.var_348 = SkinLayoutEntity.const_550;
                  break;
               case "tiled":
                  _loc5_.var_348 = SkinLayoutEntity.const_314;
                  break;
               case "center":
                  _loc5_.var_348 = SkinLayoutEntity.const_487;
            }
         }
