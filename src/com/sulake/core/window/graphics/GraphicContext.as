package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2191:uint = 64;
      
      public static const const_2150:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_600:uint = 0;
      
      protected static var var_354:uint = 0;
       
      
      protected var var_233:DisplayObjectContainer;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_233.numChildren > 0)
               {
                  this.var_233.removeChildAt(0);
               }
            }
            this.var_233 = null;
            while(numChildren > 0)
         ...
         if(this.var_917)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_354 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2221,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2221,16777215);
                  }
                  var_354 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_917)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_354 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_233 == null)
         {
            this.var_233 = new Sprite();
            this.var_233.name = this.name + " - Child Container";
            this.var_233.mouseEnabled = false;
            addChild(this.var_233);
         }
         return this.var_233;
      }
      ...
      {
         return this.var_233 != null ? int(this.var_233.numChildren) : 0;
      }
