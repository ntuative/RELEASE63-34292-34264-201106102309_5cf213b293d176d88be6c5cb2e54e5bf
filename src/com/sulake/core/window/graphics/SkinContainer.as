package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1085:uint = 8;
      
      private static const const_1565:String = "skin";
      
      private static const const_1563:String = "bitmap";
      
      private static const const_1564:String = "fill";
      
      private static const const_1560:String = "text";
      
      private static const const_1561:String = "label";
      ...
      private var var_2637:Dictionary;
      
      private var var_2636:Dictionary;
      
      private var var_2635:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2637 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1931,this.var_2637);
         this.var_2636 = new Dictionary();
         this.var_2635 = new Dictionary();
         StateCodeTable.fillTables(this.var_2636,this.var_2635);
         this.var_463 = new Dictionary();
         this.var_463[const_1565] = BitmapSkinRenderer;
         this.var_463[const_1563] = BitmapDataRenderer;
         this.var_463[const_1564] = FillSkinRenderer;
         this.var_463[const_1560] = TextSkinRenderer;
         this.var_463[const_1561] = LabelRenderer;
         this.var_463[const_1562] = ShapeSkinRenderer;
         ...
         if(var_353 == null)
         {
            ...
            var_353.push(WindowState.const_88);
            var_353.push(WindowState.const_98);
            var_353.push(WindowState.const_58);
            var_353.push(WindowState.const_90);
            var_353.push(WindowState.const_89);
            var_353.push(WindowState.const_87);
            var_353.push(WindowState.const_100);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2980 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "UserTypingMessageEvent" : false;
                  ...
                  this.addSkinRenderer(this.var_1931[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1034[param1] = new Array(const_1085);
         }
         this.var_1034[param1][param2] = param3;
         if(this.var_1035[param1] == null)
         {
            this.var_1035[param1] = new Array(const_1085);
         }
         this.var_1035[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_137)
            {
               _loc4_ = _loc3_["null"];
            }
         }
