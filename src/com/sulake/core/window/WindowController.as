package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1253:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1381:String = "_COLORIZE";
      
      protected static const const_1380:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1081:Point = new Point();
      ...
      protected var var_730:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_422 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_68 = var_422.clone();
            var_11 = var_422.clone();
         ...
         if(_loc13_)
         {
            ...
            var_497 = _loc13_.var_2980;
            if(var_496 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_258 != _loc13_.color)
            {
      ...
      {
         return this.var_730 != null ? this.var_730 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_496 = param1;
         var_258 = !!var_496 ? uint(var_258 | var_592) : uint(var_258 & 16777215);
         this.var_186 = this.var_186 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      
      public function set color(param1:uint) : void
      {
         var_592 = param1 & 4278190080;
         var_258 = !!var_496 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      ...
      {
         var_592 = param1 << 24;
         var_258 = !!var_496 ? uint(var_592 | var_258) : uint(16777215 & var_258);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_61);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1179);
      }
      ...
      {
         var_497 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_978);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_87)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1380) == -1)
               {
                  _loc4_.style = var_87;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_635,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1701,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_87,var_21,_context,var_11,null,this.var_730,this.properties,var_910.concat(),_id) as WindowController;
         _loc2_.var_497 = var_497;
         _loc2_.var_186 = this.var_186;
         _loc2_._debug = this._debug;
         _loc2_.var_380 = this.var_380.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_422 = var_422.clone();
         _loc2_.var_68 = var_68.clone();
         _loc2_.var_160 = !!var_160 ? var_160.clone() : null;
         _loc2_.var_161 = !!var_161 ? var_161.clone() : null;
         _loc2_.var_80 = !!var_80 ? var_80.clone(_loc2_) : null;
         _loc2_._context = _context;
         _loc2_.var_258 = var_258;
         _loc2_.var_592 = var_592;
         _loc2_.var_727 = var_727;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2625 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_570)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1168,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_160 != null)
         {
            param3.x = var_160.x;
            param3.y = var_160.y;
            param3.width = var_160.width;
            param3.height = var_160.height;
         }
         if(param4 != null && var_161 != null)
         {
            param4.x = var_161.x;
            param4.y = var_161.y;
            param4.width = var_161.width;
            param4.height = var_161.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            var_161.x = param3.x;
            var_161.y = param3.y;
            var_161.width = param3.width;
            var_161.height = param3.height;
         }
         if(param2 != null)
         {
            ...
            if(var_160 == null)
            {
               var_160 = new Rectangle();
            }
            var_160.x = param2.x;
            var_160.y = param2.y;
            var_160.width = param2.width;
            var_160.height = param2.height;
         }
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_45:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1225;
                  if(testParamFlag(WindowParam.const_426))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_241))
                        {
               ...
               case WindowMouseEvent.const_57:
                  ...
                  if(testParamFlag(WindowParam.const_241))
                  {
            ...
            switch(param2.type)
            {
               case WindowEvent.const_40:
                  ...
                  if(param1 == this)
                  {
                     ...
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_206,WindowParam.const_192))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_215,WindowParam.const_183))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_21 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_177,this._parent,this);
               ...
               case WindowEvent.const_410:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1212);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1927,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_231,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_493:
                  if(param1 == this)
                  {
                     ...
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_333,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_635:
                  if(testParamFlag(WindowParam.const_206,WindowParam.const_192))
                  {
                     this.updateScaleRelativeToParent();
                  }
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_497);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_497);
      }
         ...
         if(this.var_186 && var_497 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1081,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1081,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         var _loc7_:*;
         var_87 = !!param2 ? (_loc7_ = var_87 | param1, var_87 |= param1, uint(_loc7_)) : (_loc7_ = var_87 & ~param1, var_87 &= ~param1, uint(_loc7_));
         if(var_87 != _loc3_)
         {
            _loc4_ = new Array();
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1380) == -1)
               {
                  _loc6_.style = var_87;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_170,WindowParam.const_192);
         var _loc2_:* = !testParamFlag(WindowParam.const_161,WindowParam.const_183);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_420)
               {
                  _loc3_.width += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_367)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_240)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_476)
         {
            return true;
         }
         _state = WindowState.const_476;
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1789,this,null);
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_316,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1693,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_493,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1772,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1752,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1802,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_890,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_729,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_267,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1971,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1252 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_601,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1252 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_601,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
