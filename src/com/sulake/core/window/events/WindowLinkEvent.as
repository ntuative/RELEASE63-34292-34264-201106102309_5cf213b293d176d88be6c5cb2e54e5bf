package com.sulake.core.window.events
{
   ...
   public class WindowLinkEvent extends WindowEvent
   {
      ...
      public static const const_1838:String = "WE_LINK";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow) : WindowEvent
      {
         ...
         _loc4_.var_1762 = param1;
         _loc4_._window = param2;
         _loc4_.var_733 = param3;
         _loc4_.var_502 = false;
         _loc4_.var_732 = POOL;
         return _loc4_;
      }
      ...
      {
         return allocate(this.var_1762,window,related);
      }
      
      override public function toString() : String
      {
         return "WindowLinkEvent { type: " + _type + " link: " + this.link + " cancelable: " + var_500 + " window: " + _window + " }";
      }
   }
}
