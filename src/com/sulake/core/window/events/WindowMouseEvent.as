package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_2071:String = "WME_MIDDLE_CLICK";
      
      public static const const_2103:String = "WME_MIDDLE_DOWN";
      
      public static const const_2046:String = "WME_MIDDLE_UP";
      ...
      public static const const_247:String = "WME_UP_OUTSIDE";
      
      public static const const_319:String = "WME_WHEEL";
      
      public static const const_2048:String = "WME_RIGHT_CLICK";
      
      public static const const_2180:String = "WME_RIGHT_DOWN";
      
      public static const const_2203:String = "WME_RIGHT_UP";
      
      public static const const_1820:String = "WME_ROLL_OUT";
      
      public static const const_1853:String = "WME_ROLL_OVER";
      
      public static const const_2068:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_733 = param3;
         _loc13_.var_502 = false;
         _loc13_.var_732 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_500 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
