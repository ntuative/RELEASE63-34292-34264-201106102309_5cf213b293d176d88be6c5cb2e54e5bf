   ...
   class Profiler extends Component implements IProfiler
   {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               IDisposable(this.var_318[_loc1_]).dispose();
      ...
      {
         this.var_3014 = getTimer() - this.var_2127;
      ...
      public function getProfilerAgentsInArray() : Array
      {
         ...
         for(_loc3_ in this.var_318)
         {
            _loc2_ = _loc3_ as IUpdateReceiver;
            if(IDisposable(_loc3_).disposed)
            {
               IDisposable(this.var_318[_loc3_]).dispose();
               delete this.var_318[_loc3_];
            }
            else
            {
               _loc1_.push(this.var_318[_loc3_]);
            }
         }
         return _loc1_;
      }
      ...
      {
         var _loc2_:ProfilerAgent = this.var_318[param1];
