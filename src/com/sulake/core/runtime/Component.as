package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_457:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_2246:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1177:uint = 4;
       
      
      protected var var_749:uint = 0;
      ...
      private var var_546:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_546 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_546.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_546.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1394 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1394);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1499 & const_1177)
         {
            if(_loc3_ == 0)
            {
               if(this.var_546.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_1011 = false;
            this._events.dispatchEvent(new LockEvent(const_457,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_749 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_546.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_546.getStructByIndex(_loc8_);
