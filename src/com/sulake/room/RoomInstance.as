   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_284 != null)
         {
            ...
            {
               _loc3_ = this.var_284.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1540.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1541.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_668[param1] != param2)
         {
            this.var_668[param1] = param2;
         }
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_670.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_670[_loc2_]);
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         {
            return this.var_284.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_284.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_284.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_284.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
