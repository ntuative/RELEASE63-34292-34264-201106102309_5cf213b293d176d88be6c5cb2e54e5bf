package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_408:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_225 != null)
         {
            ...
            {
               _loc1_ = this.var_225[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_881.removeReference();
         }
         this.var_881 = param1;
         if(this.var_881 != null)
         {
            this.var_881.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_225.length > param1)
         {
            _loc2_ = this.var_225[this.var_225.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
