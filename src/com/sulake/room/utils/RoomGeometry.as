package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_516:Number = 64;
      
      public static const const_1143:Number = 32;
      ...
      private var var_2115:Number = 1.0;
      ...
      private var var_3034:Number = -500.0;
      
      private var var_3035:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1341 = new Vector3d();
         this.var_491 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1342 = new Vector3d();
         this.var_2115 = 1;
         this.var_2114 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2113 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_491.assign(this.var_105);
         this.var_491.x *= this.var_493;
         this.var_491.y *= this.var_492;
         this.var_491.z *= this.var_489;
         return this.var_491;
      }
      ...
      {
         if(this.var_493 != param1 * this.var_2115)
         {
            this.var_493 = param1 * this.var_2115;
            ++this.var_181;
         }
      }
      ...
      {
         if(this.var_492 != param1 * this.var_2114)
         {
            this.var_492 = param1 * this.var_2114;
            ++this.var_181;
         }
      }
      ...
      {
         if(this.var_489 != param1 * this.var_2113)
         {
            this.var_489 = param1 * this.var_2113;
            ++this.var_181;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_105.x /= this.var_493;
         this.var_105.y /= this.var_492;
         this.var_105.z /= this.var_489;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1341.assign(this.var_179);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_578 != null)
         {
            ...
            this.var_578.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_578.add(_loc3_,_loc4_);
            ++this.var_181;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_578 != null)
         {
            ...
            return this.var_578.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1342.assign(_loc22_);
         }
         else
         {
            this.var_1342.assign(_loc17_);
         }
         ++this.var_181;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_493;
         _loc2_.y *= this.var_492;
         _loc2_.z *= this.var_489;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1342);
         if(_loc3_ < this.var_3034 || _loc3_ > this.var_3035)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_492;
            _loc2_.z *= this.var_489;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1342);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_105.x * this.var_493,this.var_105.y * this.var_492,this.var_105.z * this.var_489);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_179;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_493,param2.y * this.var_492,param2.z * this.var_489);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_493,param3.y * this.var_492,param3.z * this.var_489);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_493,param4.y * this.var_492,param4.z * this.var_489);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1143;
         }
         else
         {
            this.scale = const_516;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_516;
      }
