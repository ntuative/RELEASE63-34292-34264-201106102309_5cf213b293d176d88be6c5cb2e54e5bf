package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1764:int = 1;
      ...
      private var var_3059:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_689 = [];
         this.var_670 = [];
         events.addEventListener(RoomContentLoadedEvent.const_446,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_562,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_820,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_688 == null || this.var_566 == null)
         {
            return;
         }
         this._state = const_1764;
         if(this.var_1292 != null)
         {
            _loc1_ = this.var_1292;
            this.var_1292 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_689.indexOf(_loc5_) < 0)
            {
               this.var_60.loadObjectContent(_loc5_,events);
               this.var_689.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1186;
         return true;
      }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_670.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_670[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_566.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_566.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_60.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_689.indexOf(param1);
            if(_loc2_ >= 0)
            {
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_1055.indexOf(_loc2_) < 0)
         {
            this.var_1055.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1055.length > 0)
         {
            _loc2_ = this.var_1055[0];
            this.var_1055.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_60 == null || this.var_566 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_566.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_566.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
