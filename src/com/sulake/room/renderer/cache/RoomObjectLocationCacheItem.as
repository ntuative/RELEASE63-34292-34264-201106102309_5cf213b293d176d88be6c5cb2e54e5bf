package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1840 || param1.getUpdateID() != this.var_2596)
         {
            this.var_2596 = param1.getUpdateID();
            if(param2.updateId != this.var_1840 || _loc4_.x != this.var_1245.x || _loc4_.y != this.var_1245.y || _loc4_.z != this.var_1245.z)
            {
         ...
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_379.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_379.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_379.x = Math.round(this.var_379.x);
            this.var_379.y = Math.round(this.var_379.y);
         }
         return this.var_379;
      }
   }
