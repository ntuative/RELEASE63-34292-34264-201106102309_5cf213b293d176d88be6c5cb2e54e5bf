package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1557:int = 128;
      
      private var var_1556:Boolean = false;
      
      private var var_3025:Point;
      ...
      {
         if(param1 != this.var_1960 || param2 != this.var_1959)
         {
      ...
      {
         if(this.var_1557 > 255 || bitmapData == null)
         {
            return false;
         }
         if(param1 < 0 || param2 < 0 || param1 >= this.var_283 || param2 >= this._height)
         {
            return false;
         }
