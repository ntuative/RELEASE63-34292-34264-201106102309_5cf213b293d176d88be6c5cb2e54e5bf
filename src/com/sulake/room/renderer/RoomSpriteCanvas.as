package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_376:int = 50;
      
      private static const const_1461:int = 50;
      
      private static const const_1043:Number = 60;
      
      private static const const_1460:Number = 50;
      ...
      private var var_272:BitmapDataCache;
      ...
      private var var_1484:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2468:Number = -1.0E7;
      
      private var var_2465:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_273.addChild(this.var_110);
         ...
         this.var_272 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
      ...
      {
         this.var_532.x -= param1 - this.var_650;
         this.var_650 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_532.y -= param1 - this.var_646;
         this.var_646 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1093 = true;
            if(this.var_146 != null && !this.var_273.contains(this.var_146))
            {
               this.var_273.addChild(this.var_146);
               this.var_110.mask = this.var_146;
            }
         }
         else if(!param1 && this.var_1093)
         {
            this.var_1093 = false;
            if(this.var_146 != null && this.var_273.contains(this.var_146))
            {
               this.var_273.removeChild(this.var_146);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_647.length)
            {
               this.cleanSprite(this.var_647[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_647 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_533 != this.var_2470 || this.var_534 != this.var_2464)
         {
            _loc8_ = true;
         }
         if(this.var_110.x != this.var_650 || this.var_110.y != this.var_646)
         {
            this.var_110.x = this.var_650;
            this.var_110.y = this.var_646;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_535.sortOn("z",0 | 0);
         if(_loc5_ < this.var_535.length)
         {
            this.var_535.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_535[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2470 = this.var_533;
         this.var_2464 = this.var_534;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1483 > 0)
         {
            _loc2_ = param1 - this.var_1483;
            if(_loc2_ > const_1043 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2469 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_787;
               if(this.var_787 == const_376 + 1)
               {
                  this.var_575 = _loc2_;
                  this.var_1829 = this.var_2466;
               }
               else if(this.var_787 > const_376 + 1)
               {
                  _loc3_ = Number(this.var_787 - const_376);
                  this.var_575 = this.var_575 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1829 = this.var_1829 * (_loc3_ - 1) / _loc3_ + Number(this.var_2466) / _loc3_;
                  if(this.var_787 > const_376 + const_1461)
                  {
                     this.var_787 = const_376;
                     if(!this.var_1213 && this.var_575 > const_1043)
                     {
                        this.var_1213 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1213 && this.var_575 < const_1460)
                     {
                        this.var_1213 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1830 && this.var_1213);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_646;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_535.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_650;
                     _loc17_.y = _loc20_ - this.var_646;
      ...
      {
         if(param1 < this.var_533 && param1 + param3 >= 0 && (param2 < this.var_534 && param2 + param4 >= 0))
         {
            if(!this.var_3016)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param2 + param4 >= this.var_534)
         {
            param4 -= this.var_534 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2467)
         {
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_647.length > 0)
         {
            _loc3_ = this.var_647.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_788 || this.var_788 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_535.length)
         {
            return null;
         }
         return this.var_535[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_272.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_272.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_272.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_649.identity();
            if(flipH)
            {
               this.var_649.scale(-1,1);
               this.var_649.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_649.scale(1,-1);
               this.var_649.translate(0,data.height);
            }
            finalData.draw(data,this.var_649);
            if(name.length > 0)
            {
               this.var_272.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1212 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1832;
         }
         this.var_1832 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1212;
         return this.var_1832;
      }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - this.var_534 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1831,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2468 || param2 != this.var_2465)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      {
         if(this.var_370 != null && param1 != null)
         {
            this.var_370.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_370 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_370.getKey(_loc1_);
            _loc3_ = this.var_370.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1484.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
