package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1935 = param1.invDigit();
         this.var_1934 = this.var_1935 & 32767;
         this.var_2657 = this.var_1935 >> 15;
         this.var_2658 = 131071;
         this.var_2659 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_196) > 0)
         {
