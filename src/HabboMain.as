package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_1008:Number = 0.71;
      ...
      private var var_1413:HabboTracking;
      ...
      private function initializeCore() : void
      {
         ...
         {
            Habbo.method_1(Habbo.const_21);
            Core.crash("Failed to initialize the core: " + error.message,Core.const_1133,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.method_1(Habbo.const_21);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_1133,error);
            Core.dispose();
         }
      }
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1413 = HabboTracking.getInstance();
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1413 && !this.var_1413.disposed)
                  {
                     this.var_1413.trackGoogle("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_1008 + this.var_26.getNumberOfFilesLoaded() / _loc11_ * const_1008;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
